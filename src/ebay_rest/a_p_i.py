...
class API(metaclass=Multiton):
    ...
    def buy_browse_search_by_image(self, **kwargs):  # noqa: E501
        ...
        """
        try:
            return self._method_paged(buy_browse.Configuration, '/buy/browse/v1', buy_browse.ItemSummaryApi, buy_browse.ApiClient, 'search_by_image', BuyBrowseException, False, ['buy.browse', 'item_summary'], None, **kwargs)  # noqa: E501
        except Error:
            raise
