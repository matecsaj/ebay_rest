...
class API(APIPrivate):
    ...
    def sell_metadata_get_currencies(self, marketplace_id, **kwargs):  # noqa: E501
        ...
        :param str accept_language: This header is used to indicate the natural language and locale for the response and is used when targeting a specific locale of a marketplace that supports multiple locales. For the eBay Belgium and eBay Canada marketplaces, make sure to add this header as required. For example:When targeting the French locale of the Belgium marketplace, pass in fr-BE to specify this. If this locale is not specified, the language will default to Dutch.When targeting the French locale of the Canadian marketplace, pass in fr-CA to specify this. If this locale is not specified, the language will default to English.
