...
class API(metaclass=Multiton):
    ...
    def commerce_notification_create_subscription_filter(self, subscription_id, **kwargs):  # noqa: E501
        ...
        """
        try:
            return self._method_single(commerce_notification.Configuration, '/commerce/notification/v1', commerce_notification.SubscriptionApi, commerce_notification.ApiClient, 'create_subscription_filter', CommerceNotificationException, False, ['commerce.notification', 'subscription'], subscription_id, **kwargs)  # noqa: E501
        except Error:
            raise
