...
class API(metaclass=Multiton):
    ...
    def sell_feed_create_task(self, body, x_ebay_c_marketplace_id, content_type, **kwargs):  # noqa: E501
        ...
        :param str x_ebay_c_marketplace_id: The ID of the eBay marketplace where the item is hosted.  Note: This value is case sensitive.For example:X-EBAY-C-MARKETPLACE-ID:EBAY_USThis identifies the eBay marketplace that applies to this task. See MarketplaceIdEnum. (required)
        :param str content_type: This header indicates the format of the request body provided by the client. Its value should be set to application/json.  For more information, refer to HTTP request headers. (required)
        :return: None
        """
        try:
    ...
    def sell_finances_get_payout(self, x_ebay_c_marketplace_id, payout_id, **kwargs):  # noqa: E501
        ...
        :param str x_ebay_c_marketplace_id: This header identifies the seller's eBay marketplace. It is required for all marketplaces outside of the US.Note: If a marketplace ID value is not provided, the default value of EBAY_US is used.  See HTTP request headers for the marketplace ID values. (required)
    ...
    def sell_marketing_suggest_budget(self, x_ebay_c_marketplace_id, **kwargs):  # noqa: E501
        ...
        Note: This method is only supported for Offsite Ads campaigns. Sellers can use the getAdvertisingEligibility method of the Account API v1 to determine if they are eligible for Offsite Ads. This method allow sellers to retrieve the suggested budget for an Offsite Ads campaign.  
    ...
    def sell_marketing_get_email_campaigns(self, **kwargs):  # noqa: E501
        ...
        :param str q: This field contains filter criteria for the results returned. Filter by email campaign type, email campaign status, and marketplace ID.For example, setting q=campaignType:WELCOME,ITEM_SHOWCASE;status:ACTIVE will return only active Welcome and Item Showcase email campaigns.If no filter is set up through the q query parameter, all of the seller's campaigns will be returned in the results set. 
