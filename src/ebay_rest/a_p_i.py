...
class API(APIPrivate):
    ...
    def __init__(
        ...
        :param path: If using an ebay_rest.json file that is not in the current working directory, supply a full path.

        :param application: Supply the name of the desired application record in ebay_rest.json or a dict with application credentials.
                            Can omit when ebay_rest.json contains only one application record.

        :param user: Supply the name of the desired user record in ebay_rest.json or a dict with user credentials.
                     Can omit when ebay_rest.json contains only one user record.

        :param header: Supply the name of the desired header record in ebay_rest.json or a dict with header credentials.
                       Can omit when ebay_rest.json contains only one header record.

        :param throttle: When True block the call if a below the prorated call limit, defaults to False.
        ...
        :param timeout: When invoked with the floating-point timeout argument set to a positive value,
                        throttle for at most the number of seconds specified by timeout and as below the prorated call limit.
                        A timeout argument of -1 specifies an unbounded wait.
                        It is forbidden to specify a timeout when the throttle is False.
                        Defaults to -1.

        :param key_pair: Supply the name of the desired eBay public/private key pair record in ebay_rest.json or
                         a dict with the key pair details.
                         Can omit when ebay_rest.json contains only one record.

        :param digital_signatures: Use eBay digital signatures

        :param async_req: When True make asynchronous HTTP requests, defaults to False for synchronous.
    ...
    def buy_browse_check_compatibility(self, content_type, item_id, **kwargs):  # noqa: E501
        """check_compatibility  
    ...
    def buy_browse_get_item_by_legacy_id(self, legacy_item_id, **kwargs):  # noqa: E501
        ...
        :param str fieldgroups: This field controls what is returned in the response. If this field is not set, the method returns all details about the item. Multiple fieldgroups can be set.Valid Values: PRODUCTThis field group adds the product container to the response. ADDITIONAL_SELLER_DETAILSThis field group adds the userId field to the response.CHARITY_DETAILSThis field group adds the the charityTerms container to the response, if applicable.
    ...
    def buy_browse_get_items_by_item_group(self, item_group_id, **kwargs):  # noqa: E501
        ...
        :param str fieldgroups: This field controls what is returned in the response. If this field is not set, the method returns all details about the item.Valid Values:ADDITIONAL_SELLER_DETAILS - This field group adds the userId field to the response.CHARITY_DETAILS - This field group adds the the charityTerms container to the response, if applicable.
        :param str x_ebay_c_enduserctx: This header is can be used in following two situations:To retrieve the itemAffiliateWebUrl field in the response, the ePN affiliate can pass in their affiliate credentials using this header. For more information, see Header for affiliate information.If the listing is using calculated or flat-rate shipping with shipping rate tables, the user can use this header to provide country and postal code in order for the shippingOption container, which includes shipping costs and delivery estimates, to be returned. For more information, see Header for shipping information accuracy.
        :param str x_ebay_c_marketplace_id: This header identifies the seller's eBay marketplace. It is required for all marketplaces outside of the US.Note: If the marketplace ID value is invalid or missing, the default value of EBAY_US is used.See MarketplaceIdEnum for a list of supported marketplaces.Default: EBAY_US
        :param str accept_language: This header is used to indicate the natural language and locale preferred by the user for the response.This header is required when targeting a specific locale of a marketplace that supports multiple locales. For example:When targeting the French locale of the Belgium marketplace, it is required to pass in fr-BE to specify this. If this locale is not specified, the language will default to Dutch.When targeting the French locale of the Canadian marketplace, it is required to pass in fr-CA to specify this. If this locale is not specified, the language will default to English.
        :param str quantity_for_shipping_estimate: This query parameter sets the item quantity to be used when calculating the shipping estimate information returned in the shippingOptions container of the response.This value must be a positive integer value and should not exceed the quantity available in the listing. This field is not recommended for auction listings, as they will always have a quantity of 1.
    ...
    def buy_browse_search(self, **kwargs):  # noqa: E501
        ...
        :param str gtin: This field lets you search for a product by specifying a Global Trade Item Number (GTIN) of the product. Supported GTIN types are UPC, EAN, and ISBN.For example:/buy/browse/v1/item_summary/search?gtin=099482432621Note: When constructing a query, gtin value may be combined with an epid value, but neither an epid or gtin value should be combined with a keywords search through the q parameter.
    ...
    def buy_browse_search_by_image(self, content_type, **kwargs):  # noqa: E501
        ...
        :return: SearchPagedCollection
        """
        return self._method_paged(buy_browse.Configuration, '/buy/browse/v1', buy_browse.ItemSummaryApi, buy_browse.ApiClient, 'search_by_image', BuyBrowseException, False, ['buy.browse', 'item_summary'], content_type, **kwargs)  # noqa: E501
    ...
    def buy_feed_get_access(self, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(buy_feed.Configuration, '/buy/feed/v1', buy_feed.AccessApi, buy_feed.ApiClient, 'get_access', BuyFeedException, False, ['buy.feed', 'access'], None, **kwargs)  # noqa: E501
    ...
    def buy_feed_get_feed_type(self, feed_type_id, **kwargs):  # noqa: E501
        ...
        :return: FeedType
        """
        return self._method_single(buy_feed.Configuration, '/buy/feed/v1', buy_feed.FeedTypeApi, buy_feed.ApiClient, 'get_feed_type', BuyFeedException, False, ['buy.feed', 'feed_type'], feed_type_id, **kwargs)  # noqa: E501
    ...
    def buy_feed_download_file(self, file_id, x_ebay_c_marketplace_id, **kwargs):  # noqa: E501
        ...
        :return: OutputStream
        """
        return self._method_single(buy_feed.Configuration, '/buy/feed/v1', buy_feed.FileApi, buy_feed.ApiClient, 'download_file', BuyFeedException, False, ['buy.feed', 'file'], (file_id, x_ebay_c_marketplace_id), **kwargs)  # noqa: E501

    def buy_feed_get_file(self, file_id, x_ebay_c_marketplace_id, **kwargs):  # noqa: E501
        """get_file  

        Use the getFile method to fetch the details of a feed file available to download, as specified by the file's file_id.Details in the response include: the feed's file_id, the date it became available, eBay categories that support the feed, its frequency, the time span it covers, its feed type, its format, its size in bytes, the schema under which it was pulled, and the marketplaces it applies to.  
        ...
        :return: FileMetadata
        """
        return self._method_single(buy_feed.Configuration, '/buy/feed/v1', buy_feed.FileApi, buy_feed.ApiClient, 'get_file', BuyFeedException, False, ['buy.feed', 'file'], (file_id, x_ebay_c_marketplace_id), **kwargs)  # noqa: E501

    def buy_feed_get_files(self, feed_type_id, x_ebay_c_marketplace_id, **kwargs):  # noqa: E501
        """get_files  

        The getFiles method provides a list of the feed files available for download.Details for each feed returned include the date the feed was generated, the frequency with which it is pulled, its feed type, its fileId, its format, the eBay marketplaces it applies to, the schema version under which it was generated, its size in bytes, and the time span it covers (in hours).You can limit your search results by feed type, marketplace, scope, eBay L1 category, and how far back in time from the present the feed was made available. Set the look_back field to control exactly how many feeds from the past are retrieved.Restrictions For a list of supported sites and other restrictions, see API Restrictions.  
        ...
        """
        return self._method_single(buy_feed.Configuration, '/buy/feed/v1', buy_feed.FileApi, buy_feed.ApiClient, 'get_files', BuyFeedException, False, ['buy.feed', 'file'], (feed_type_id, x_ebay_c_marketplace_id), **kwargs)  # noqa: E501
    ...
    def buy_marketing_get_merchandised_products(self, category_id, metric_name, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(buy_marketing.Configuration, '/buy/marketing/v1', buy_marketing.MerchandisedProductApi, buy_marketing.ApiClient, 'get_merchandised_products', BuyMarketingException, False, ['buy.marketing', 'merchandised_product'], (category_id, metric_name), **kwargs)  # noqa: E501
    ...
    def buy_marketing_get_most_watched_items(self, category_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(buy_marketing.Configuration, '/buy/marketing/v1', buy_marketing.MostWatchedItemsApi, buy_marketing.ApiClient, 'get_most_watched_items', BuyMarketingException, False, ['buy.marketing', 'most_watched_items'], category_id, **kwargs)  # noqa: E501
    ...
    def buy_marketing_get_similar_items(self, item_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(buy_marketing.Configuration, '/buy/marketing/v1', buy_marketing.SimilarItemsApi, buy_marketing.ApiClient, 'get_similar_items', BuyMarketingException, False, ['buy.marketing', 'similar_items'], item_id, **kwargs)  # noqa: E501
    ...
    def buy_offer_place_proxy_bid(self, x_ebay_c_marketplace_id, content_type, item_id, **kwargs):  # noqa: E501
        """place_proxy_bid  
        ...
        """
        return self._method_single(buy_offer.Configuration, '/buy/offer/v1_beta', buy_offer.BiddingApi, buy_offer.ApiClient, 'place_proxy_bid', BuyOfferException, True, ['buy.offer', 'bidding'], (x_ebay_c_marketplace_id, content_type, item_id), **kwargs)  # noqa: E501

    def buy_order_apply_guest_coupon(self, x_ebay_c_marketplace_id, content_type, checkout_session_id, **kwargs):  # noqa: E501
        """apply_guest_coupon  
        ...
        """
        return self._method_single(buy_order.Configuration, '/buy/order/v2', buy_order.GuestCheckoutSessionApi, buy_order.ApiClient, 'apply_guest_coupon', BuyOrderException, False, ['buy.order', 'guest_checkout_session'], (x_ebay_c_marketplace_id, content_type, checkout_session_id), **kwargs)  # noqa: E501
    ...
    def buy_order_initiate_guest_checkout_session(self, x_ebay_c_marketplace_id, content_type, **kwargs):  # noqa: E501
        ...
        :return: GuestCheckoutSessionResponseV2
        """
        return self._method_single(buy_order.Configuration, '/buy/order/v2', buy_order.GuestCheckoutSessionApi, buy_order.ApiClient, 'initiate_guest_checkout_session', BuyOrderException, False, ['buy.order', 'guest_checkout_session'], (x_ebay_c_marketplace_id, content_type), **kwargs)  # noqa: E501

    def buy_order_remove_guest_coupon(self, x_ebay_c_marketplace_id, content_type, checkout_session_id, **kwargs):  # noqa: E501
        """remove_guest_coupon  
        ...
        :return: GuestCheckoutSessionResponseV2
        """
        return self._method_single(buy_order.Configuration, '/buy/order/v2', buy_order.GuestCheckoutSessionApi, buy_order.ApiClient, 'remove_guest_coupon', BuyOrderException, False, ['buy.order', 'guest_checkout_session'], (x_ebay_c_marketplace_id, content_type, checkout_session_id), **kwargs)  # noqa: E501

    def buy_order_update_guest_quantity(self, x_ebay_c_marketplace_id, content_type, checkout_session_id, **kwargs):  # noqa: E501
        ...
        :return: GuestCheckoutSessionResponseV2
        """
        return self._method_single(buy_order.Configuration, '/buy/order/v2', buy_order.GuestCheckoutSessionApi, buy_order.ApiClient, 'update_guest_quantity', BuyOrderException, False, ['buy.order', 'guest_checkout_session'], (x_ebay_c_marketplace_id, content_type, checkout_session_id), **kwargs)  # noqa: E501

    def buy_order_update_guest_shipping_address(self, x_ebay_c_marketplace_id, content_type, checkout_session_id, **kwargs):  # noqa: E501
        ...
        :return: GuestCheckoutSessionResponseV2
        """
        return self._method_single(buy_order.Configuration, '/buy/order/v2', buy_order.GuestCheckoutSessionApi, buy_order.ApiClient, 'update_guest_shipping_address', BuyOrderException, False, ['buy.order', 'guest_checkout_session'], (x_ebay_c_marketplace_id, content_type, checkout_session_id), **kwargs)  # noqa: E501

    def buy_order_update_guest_shipping_option(self, x_ebay_c_marketplace_id, content_type, checkout_session_id, **kwargs):  # noqa: E501
        ...
        :return: GuestCheckoutSessionResponseV2
        """
        return self._method_single(buy_order.Configuration, '/buy/order/v2', buy_order.GuestCheckoutSessionApi, buy_order.ApiClient, 'update_guest_shipping_option', BuyOrderException, False, ['buy.order', 'guest_checkout_session'], (x_ebay_c_marketplace_id, content_type, checkout_session_id), **kwargs)  # noqa: E501
    ...
    def commerce_media_create_document(self, content_type, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(commerce_media.Configuration, '/commerce/media/v1_beta', commerce_media.DocumentApi, commerce_media.ApiClient, 'create_document', CommerceMediaException, True, ['commerce.media', 'document'], content_type, **kwargs)  # noqa: E501

    def commerce_media_create_document_from_url(self, content_type, **kwargs):  # noqa: E501
        ...
        :return: CreateDocumentResponse
        """
        return self._method_single(commerce_media.Configuration, '/commerce/media/v1_beta', commerce_media.DocumentApi, commerce_media.ApiClient, 'create_document_from_url', CommerceMediaException, True, ['commerce.media', 'document'], content_type, **kwargs)  # noqa: E501
    ...
    def commerce_media_get_document(self, document_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(commerce_media.Configuration, '/commerce/media/v1_beta', commerce_media.DocumentApi, commerce_media.ApiClient, 'get_document', CommerceMediaException, True, ['commerce.media', 'document'], document_id, **kwargs)  # noqa: E501

    def commerce_media_upload_document(self, document_id, content_type, **kwargs):  # noqa: E501
        """upload_document  
        ...
        :return: DocumentResponse
        """
        return self._method_single(commerce_media.Configuration, '/commerce/media/v1_beta', commerce_media.DocumentApi, commerce_media.ApiClient, 'upload_document', CommerceMediaException, True, ['commerce.media', 'document'], (document_id, content_type), **kwargs)  # noqa: E501

    def commerce_media_create_image_from_file(self, content_type, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(commerce_media.Configuration, '/commerce/media/v1_beta', commerce_media.ImageApi, commerce_media.ApiClient, 'create_image_from_file', CommerceMediaException, True, ['commerce.media', 'image'], content_type, **kwargs)  # noqa: E501

    def commerce_media_create_image_from_url(self, body, content_type, **kwargs):  # noqa: E501
        ...
        :return: ImageResponse
        """
        return self._method_single(commerce_media.Configuration, '/commerce/media/v1_beta', commerce_media.ImageApi, commerce_media.ApiClient, 'create_image_from_url', CommerceMediaException, True, ['commerce.media', 'image'], (body, content_type), **kwargs)  # noqa: E501

    def commerce_media_get_image(self, image_id, **kwargs):  # noqa: E501
        """get_image  
        ...
        :param str image_id: This path parameter is the unique identifier of a created image. Use the value returned in the location header of the method used to create the image (createImageFromFile or createImageFromUrl, as applicable). (required)
        :return: ImageResponse
        """
        return self._method_single(commerce_media.Configuration, '/commerce/media/v1_beta', commerce_media.ImageApi, commerce_media.ApiClient, 'get_image', CommerceMediaException, True, ['commerce.media', 'image'], image_id, **kwargs)  # noqa: E501
    ...
    def commerce_media_create_video(self, content_type, **kwargs):  # noqa: E501
        ...
        :return: None
        """
        return self._method_single(commerce_media.Configuration, '/commerce/media/v1_beta', commerce_media.VideoApi, commerce_media.ApiClient, 'create_video', CommerceMediaException, True, ['commerce.media', 'video'], content_type, **kwargs)  # noqa: E501
    ...
    def commerce_notification_update_config(self, content_type, **kwargs):  # noqa: E501
        ...
        :return: None
        """
        return self._method_single(commerce_notification.Configuration, '/commerce/notification/v1', commerce_notification.ConfigApi, commerce_notification.ApiClient, 'update_config', CommerceNotificationException, False, ['commerce.notification', 'config'], content_type, **kwargs)  # noqa: E501

    def commerce_notification_create_destination(self, content_type, **kwargs):  # noqa: E501
        """create_destination  
        ...
        :return: object
        """
        return self._method_single(commerce_notification.Configuration, '/commerce/notification/v1', commerce_notification.DestinationApi, commerce_notification.ApiClient, 'create_destination', CommerceNotificationException, False, ['commerce.notification', 'destination'], content_type, **kwargs)  # noqa: E501
    ...
    def commerce_notification_update_destination(self, content_type, destination_id, **kwargs):  # noqa: E501
        """update_destination  
        ...
        :return: None
        """
        return self._method_single(commerce_notification.Configuration, '/commerce/notification/v1', commerce_notification.DestinationApi, commerce_notification.ApiClient, 'update_destination', CommerceNotificationException, False, ['commerce.notification', 'destination'], (content_type, destination_id), **kwargs)  # noqa: E501
    ...
    def commerce_notification_create_subscription(self, content_type, **kwargs):  # noqa: E501
        """create_subscription  
        ...
        :return: object
        """
        return self._method_single(commerce_notification.Configuration, '/commerce/notification/v1', commerce_notification.SubscriptionApi, commerce_notification.ApiClient, 'create_subscription', CommerceNotificationException, False, ['commerce.notification', 'subscription'], content_type, **kwargs)  # noqa: E501

    def commerce_notification_create_subscription_filter(self, content_type, subscription_id, **kwargs):  # noqa: E501
        ...
        :return: object
        """
        return self._method_single(commerce_notification.Configuration, '/commerce/notification/v1', commerce_notification.SubscriptionApi, commerce_notification.ApiClient, 'create_subscription_filter', CommerceNotificationException, False, ['commerce.notification', 'subscription'], (content_type, subscription_id), **kwargs)  # noqa: E501
    ...
    def commerce_notification_delete_subscription_filter(self, filter_id, subscription_id, **kwargs):  # noqa: E501
        ...
        :return: None
        """
        return self._method_single(commerce_notification.Configuration, '/commerce/notification/v1', commerce_notification.SubscriptionApi, commerce_notification.ApiClient, 'delete_subscription_filter', CommerceNotificationException, False, ['commerce.notification', 'subscription'], (filter_id, subscription_id), **kwargs)  # noqa: E501
    ...
    def commerce_notification_get_subscription_filter(self, filter_id, subscription_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(commerce_notification.Configuration, '/commerce/notification/v1', commerce_notification.SubscriptionApi, commerce_notification.ApiClient, 'get_subscription_filter', CommerceNotificationException, False, ['commerce.notification', 'subscription'], (filter_id, subscription_id), **kwargs)  # noqa: E501
    ...
    def commerce_notification_test_subscription(self, subscription_id, **kwargs):  # noqa: E501
        """test_subscription  
        ...
        :return: None
        """
        return self._method_single(commerce_notification.Configuration, '/commerce/notification/v1', commerce_notification.SubscriptionApi, commerce_notification.ApiClient, 'test_subscription', CommerceNotificationException, False, ['commerce.notification', 'subscription'], subscription_id, **kwargs)  # noqa: E501

    def commerce_notification_update_subscription(self, content_type, subscription_id, **kwargs):  # noqa: E501
        """update_subscription  
        ...
        :return: None
        """
        return self._method_single(commerce_notification.Configuration, '/commerce/notification/v1', commerce_notification.SubscriptionApi, commerce_notification.ApiClient, 'update_subscription', CommerceNotificationException, False, ['commerce.notification', 'subscription'], (content_type, subscription_id), **kwargs)  # noqa: E501
    ...
    def commerce_taxonomy_get_expired_categories(self, category_tree_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(commerce_taxonomy.Configuration, '/commerce/taxonomy/v1', commerce_taxonomy.CategoryTreeApi, commerce_taxonomy.ApiClient, 'get_expired_categories', CommerceTaxonomyException, False, ['commerce.taxonomy', 'category_tree'], category_tree_id, **kwargs)  # noqa: E501
    ...
    def commerce_translation_translate(self, body, content_type, **kwargs):  # noqa: E501
        """translate  
        ...
        """
        return self._method_single(commerce_translation.Configuration, '/commerce/translation/v1_beta', commerce_translation.LanguageApi, commerce_translation.ApiClient, 'translate', CommerceTranslationException, False, ['commerce.translation', 'language'], (body, content_type), **kwargs)  # noqa: E501
    ...
    def developer_client_registration_register_client(self, body, content_type, **kwargs):  # noqa: E501
        """register_client  
        ...
        """
        return self._method_single(developer_client_registration.Configuration, '/developer/registration/v1', developer_client_registration.RegisterApi, developer_client_registration.ApiClient, 'register_client', DeveloperClientRegistrationException, False, ['developer.client.registration', 'register'], (body, content_type), **kwargs)  # noqa: E501

    def developer_key_management_create_signing_key(self, content_type, **kwargs):  # noqa: E501
        """create_signing_key  
        ...
        :return: SigningKey
        """
        return self._method_single(developer_key_management.Configuration, '/developer/key_management/v1', developer_key_management.SigningKeyApi, developer_key_management.ApiClient, 'create_signing_key', DeveloperKeyManagementException, False, ['developer.key.management', 'signing_key'], content_type, **kwargs)  # noqa: E501
    ...
    def sell_account_get_payout_settings(self, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_account.Configuration, '/sell/account/v2', sell_account.PayoutSettingsApi, sell_account.ApiClient, 'get_payout_settings', SellAccountException, True, ['sell.account', 'payout_settings'], None, **kwargs)  # noqa: E501

    def sell_account_update_payout_percentage(self, content_type, **kwargs):  # noqa: E501
        ...
        :return: None
        """
        return self._method_single(sell_account.Configuration, '/sell/account/v2', sell_account.PayoutSettingsApi, sell_account.ApiClient, 'update_payout_percentage', SellAccountException, True, ['sell.account', 'payout_settings'], content_type, **kwargs)  # noqa: E501
    ...
    def sell_account_get_rate_table(self, rate_table_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_account.Configuration, '/sell/account/v2', sell_account.RateTableApi, sell_account.ApiClient, 'get_rate_table', SellAccountException, True, ['sell.account', 'rate_table'], rate_table_id, **kwargs)  # noqa: E501

    def sell_account_update_shipping_cost(self, content_type, rate_table_id, **kwargs):  # noqa: E501
        ...
        :return: None
        """
        return self._method_single(sell_account.Configuration, '/sell/account/v2', sell_account.RateTableApi, sell_account.ApiClient, 'update_shipping_cost', SellAccountException, True, ['sell.account', 'rate_table'], (content_type, rate_table_id), **kwargs)  # noqa: E501
    ...
    def sell_compliance_get_listing_violations(self, x_ebay_c_marketplace_id, compliance_type, **kwargs):  # noqa: E501
        ...
        :param str compliance_type: Note: The ASPECTS_ADOPTION compliance type has been deprecated and will be decommissioned on September 9th, 2025.This query parameter specifies the compliance type of the listing violations being retrieved. Only one compliance type value can be specified.  See ComplianceTypeEnum for more information on supported compliance types. (required)
        ...
        """
        return self._method_paged(sell_compliance.Configuration, '/sell/compliance/v1', sell_compliance.ListingViolationApi, sell_compliance.ApiClient, 'get_listing_violations', SellComplianceException, True, ['sell.compliance', 'listing_violation'], (x_ebay_c_marketplace_id, compliance_type), **kwargs)  # noqa: E501

    def sell_compliance_get_listing_violations_summary(self, x_ebay_c_marketplace_id, **kwargs):  # noqa: E501
        ...
        :param str x_ebay_c_marketplace_id: This header identifies the seller's eBay marketplace. Supported values for this header can be found in the MarketplaceIdEnum type definition. (required)
        :param str compliance_type: Note: The ASPECTS_ADOPTION compliance type has been deprecated and will be decommissioned on September 9th, 2025.This query parameter specifies the compliance type(s) of the listing violation counts being retrieved. See ComplianceTypeEnum for more information on the supported compliance types that can be passed in here. If more than one compliance type value is used, delimit these values with a comma. If no compliance type values are passed in, the listing count for all compliance types will be returned.  Note: Only a canned response, with counts for all listing compliance types, is returned in the Sandbox environment. Due to this limitation, the compliance_type query parameter (if used) will not have an effect on the response. 
        :return: ComplianceSummary
        """
        return self._method_single(sell_compliance.Configuration, '/sell/compliance/v1', sell_compliance.ListingViolationSummaryApi, sell_compliance.ApiClient, 'get_listing_violations_summary', SellComplianceException, True, ['sell.compliance', 'listing_violation_summary'], x_ebay_c_marketplace_id, **kwargs)  # noqa: E501

    def sell_feed_create_customer_service_metric_task(self, body, accept_language, content_type, **kwargs):  # noqa: E501
        ...
        :return: None
        """
        return self._method_single(sell_feed.Configuration, '/sell/feed/v1', sell_feed.CustomerServiceMetricTaskApi, sell_feed.ApiClient, 'create_customer_service_metric_task', SellFeedException, True, ['sell.feed', 'customer_service_metric_task'], (body, accept_language, content_type), **kwargs)  # noqa: E501
    ...
    def sell_feed_create_inventory_task(self, body, content_type, **kwargs):  # noqa: E501
        ...
        :return: None
        """
        return self._method_single(sell_feed.Configuration, '/sell/feed/v1', sell_feed.InventoryTaskApi, sell_feed.ApiClient, 'create_inventory_task', SellFeedException, True, ['sell.feed', 'inventory_task'], (body, content_type), **kwargs)  # noqa: E501
    ...
    def sell_feed_create_order_task(self, body, content_type, **kwargs):  # noqa: E501
        ...
        :return: None
        """
        return self._method_single(sell_feed.Configuration, '/sell/feed/v1', sell_feed.OrderTaskApi, sell_feed.ApiClient, 'create_order_task', SellFeedException, True, ['sell.feed', 'order_task'], (body, content_type), **kwargs)  # noqa: E501
    ...
    def sell_feed_create_schedule(self, body, content_type, **kwargs):  # noqa: E501
        ...
        :return: object
        """
        return self._method_single(sell_feed.Configuration, '/sell/feed/v1', sell_feed.ScheduleApi, sell_feed.ApiClient, 'create_schedule', SellFeedException, True, ['sell.feed', 'schedule'], (body, content_type), **kwargs)  # noqa: E501
    ...
    def sell_feed_update_schedule(self, body, content_type, schedule_id, **kwargs):  # noqa: E501
        """update_schedule  
        ...
        :return: None
        """
        return self._method_single(sell_feed.Configuration, '/sell/feed/v1', sell_feed.ScheduleApi, sell_feed.ApiClient, 'update_schedule', SellFeedException, True, ['sell.feed', 'schedule'], (body, content_type, schedule_id), **kwargs)  # noqa: E501

    def sell_feed_create_task(self, body, x_ebay_c_marketplace_id, content_type, **kwargs):  # noqa: E501
        """create_task  
        ...
        :return: None
        """
        return self._method_single(sell_feed.Configuration, '/sell/feed/v1', sell_feed.TaskApi, sell_feed.ApiClient, 'create_task', SellFeedException, True, ['sell.feed', 'task'], (body, x_ebay_c_marketplace_id, content_type), **kwargs)  # noqa: E501
    ...
    def sell_feed_upload_file(self, task_id, content_type, **kwargs):  # noqa: E501
        ...
        :return: object
        """
        return self._method_single(sell_feed.Configuration, '/sell/feed/v1', sell_feed.TaskApi, sell_feed.ApiClient, 'upload_file', SellFeedException, True, ['sell.feed', 'task'], (task_id, content_type), **kwargs)  # noqa: E501

    def sell_finances_get_payout(self, x_ebay_c_marketplace_id, payout_id, **kwargs):  # noqa: E501
        """get_payout  
        ...
        :return: Payout
        """
        return self._method_single(sell_finances.Configuration, '/sell/finances/v1', sell_finances.PayoutApi, sell_finances.ApiClient, 'get_payout', SellFinancesException, True, ['sell.finances', 'payout'], (x_ebay_c_marketplace_id, payout_id), **kwargs)  # noqa: E501

    def sell_finances_get_payout_summary(self, x_ebay_c_marketplace_id, **kwargs):  # noqa: E501
        """get_payout_summary  
        ...
        """
        return self._method_single(sell_finances.Configuration, '/sell/finances/v1', sell_finances.PayoutApi, sell_finances.ApiClient, 'get_payout_summary', SellFinancesException, True, ['sell.finances', 'payout'], x_ebay_c_marketplace_id, **kwargs)  # noqa: E501

    def sell_finances_get_payouts(self, x_ebay_c_marketplace_id, **kwargs):  # noqa: E501
        """get_payouts  
        ...
        :return: Payouts
        """
        return self._method_paged(sell_finances.Configuration, '/sell/finances/v1', sell_finances.PayoutApi, sell_finances.ApiClient, 'get_payouts', SellFinancesException, True, ['sell.finances', 'payout'], x_ebay_c_marketplace_id, **kwargs)  # noqa: E501

    def sell_finances_get_seller_funds_summary(self, x_ebay_c_marketplace_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_finances.Configuration, '/sell/finances/v1', sell_finances.SellerFundsSummaryApi, sell_finances.ApiClient, 'get_seller_funds_summary', SellFinancesException, True, ['sell.finances', 'seller_funds_summary'], x_ebay_c_marketplace_id, **kwargs)  # noqa: E501

    def sell_finances_get_transaction_summary(self, x_ebay_c_marketplace_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_finances.Configuration, '/sell/finances/v1', sell_finances.TransactionApi, sell_finances.ApiClient, 'get_transaction_summary', SellFinancesException, True, ['sell.finances', 'transaction'], x_ebay_c_marketplace_id, **kwargs)  # noqa: E501

    def sell_finances_get_transactions(self, x_ebay_c_marketplace_id, **kwargs):  # noqa: E501
        """get_transactions  
        ...
        :return: Transactions
        """
        return self._method_paged(sell_finances.Configuration, '/sell/finances/v1', sell_finances.TransactionApi, sell_finances.ApiClient, 'get_transactions', SellFinancesException, True, ['sell.finances', 'transaction'], x_ebay_c_marketplace_id, **kwargs)  # noqa: E501

    def sell_finances_get_transfer(self, x_ebay_c_marketplace_id, transfer_id, **kwargs):  # noqa: E501
        """get_transfer  
        ...
        :return: Transfer
        """
        return self._method_single(sell_finances.Configuration, '/sell/finances/v1', sell_finances.TransferApi, sell_finances.ApiClient, 'get_transfer', SellFinancesException, True, ['sell.finances', 'transfer'], (x_ebay_c_marketplace_id, transfer_id), **kwargs)  # noqa: E501
    ...
    def sell_fulfillment_issue_refund(self, content_type, order_id, **kwargs):  # noqa: E501
        """Issue Refund  
        ...
        :return: Refund
        """
        return self._method_single(sell_fulfillment.Configuration, '/sell/fulfillment/v1', sell_fulfillment.OrderApi, sell_fulfillment.ApiClient, 'issue_refund', SellFulfillmentException, True, ['sell.fulfillment', 'order'], (content_type, order_id), **kwargs)  # noqa: E501

    def sell_fulfillment_accept_payment_dispute(self, content_type, payment_dispute_id, **kwargs):  # noqa: E501
        ...
        :return: None
        """
        return self._method_single(sell_fulfillment.Configuration, '/sell/fulfillment/v1', sell_fulfillment.PaymentDisputeApi, sell_fulfillment.ApiClient, 'accept_payment_dispute', SellFulfillmentException, True, ['sell.fulfillment', 'payment_dispute'], (content_type, payment_dispute_id), **kwargs)  # noqa: E501

    def sell_fulfillment_add_evidence(self, content_type, payment_dispute_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_fulfillment.Configuration, '/sell/fulfillment/v1', sell_fulfillment.PaymentDisputeApi, sell_fulfillment.ApiClient, 'add_evidence', SellFulfillmentException, True, ['sell.fulfillment', 'payment_dispute'], (content_type, payment_dispute_id), **kwargs)  # noqa: E501

    def sell_fulfillment_contest_payment_dispute(self, content_type, payment_dispute_id, **kwargs):  # noqa: E501
        ...
        :return: None
        """
        return self._method_single(sell_fulfillment.Configuration, '/sell/fulfillment/v1', sell_fulfillment.PaymentDisputeApi, sell_fulfillment.ApiClient, 'contest_payment_dispute', SellFulfillmentException, True, ['sell.fulfillment', 'payment_dispute'], (content_type, payment_dispute_id), **kwargs)  # noqa: E501
    ...
    def sell_fulfillment_update_evidence(self, content_type, payment_dispute_id, **kwargs):  # noqa: E501
        """Update evidence  
        ...
        :return: None
        """
        return self._method_single(sell_fulfillment.Configuration, '/sell/fulfillment/v1', sell_fulfillment.PaymentDisputeApi, sell_fulfillment.ApiClient, 'update_evidence', SellFulfillmentException, True, ['sell.fulfillment', 'payment_dispute'], (content_type, payment_dispute_id), **kwargs)  # noqa: E501

    def sell_fulfillment_upload_evidence_file(self, payment_dispute_id, content_type, **kwargs):  # noqa: E501
        ...
        :return: FileEvidence
        """
        return self._method_single(sell_fulfillment.Configuration, '/sell/fulfillment/v1', sell_fulfillment.PaymentDisputeApi, sell_fulfillment.ApiClient, 'upload_evidence_file', SellFulfillmentException, True, ['sell.fulfillment', 'payment_dispute'], (payment_dispute_id, content_type), **kwargs)  # noqa: E501

    def sell_fulfillment_create_shipping_fulfillment(self, body, content_type, order_id, **kwargs):  # noqa: E501
        ...
        :return: object
        """
        return self._method_single(sell_fulfillment.Configuration, '/sell/fulfillment/v1', sell_fulfillment.ShippingFulfillmentApi, sell_fulfillment.ApiClient, 'create_shipping_fulfillment', SellFulfillmentException, True, ['sell.fulfillment', 'shipping_fulfillment'], (body, content_type, order_id), **kwargs)  # noqa: E501
    ...
    def sell_inventory_bulk_create_or_replace_inventory_item(self, body, content_type, content_language, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_inventory.Configuration, '/sell/inventory/v1', sell_inventory.InventoryItemApi, sell_inventory.ApiClient, 'bulk_create_or_replace_inventory_item', SellInventoryException, True, ['sell.inventory', 'inventory_item'], (body, content_type, content_language), **kwargs)  # noqa: E501

    def sell_inventory_bulk_get_inventory_item(self, body, content_type, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_inventory.Configuration, '/sell/inventory/v1', sell_inventory.InventoryItemApi, sell_inventory.ApiClient, 'bulk_get_inventory_item', SellInventoryException, True, ['sell.inventory', 'inventory_item'], (body, content_type), **kwargs)  # noqa: E501

    def sell_inventory_bulk_update_price_quantity(self, body, content_type, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_inventory.Configuration, '/sell/inventory/v1', sell_inventory.InventoryItemApi, sell_inventory.ApiClient, 'bulk_update_price_quantity', SellInventoryException, True, ['sell.inventory', 'inventory_item'], (body, content_type), **kwargs)  # noqa: E501

    def sell_inventory_create_or_replace_inventory_item(self, body, content_language, content_type, sku, **kwargs):  # noqa: E501
        ...
        :return: BaseResponse
        """
        return self._method_single(sell_inventory.Configuration, '/sell/inventory/v1', sell_inventory.InventoryItemApi, sell_inventory.ApiClient, 'create_or_replace_inventory_item', SellInventoryException, True, ['sell.inventory', 'inventory_item'], (body, content_language, content_type, sku), **kwargs)  # noqa: E501
    ...
    def sell_inventory_create_or_replace_inventory_item_group(self, body, content_language, content_type, inventory_item_group_key, **kwargs):  # noqa: E501
        ...
        :return: BaseResponse
        """
        return self._method_single(sell_inventory.Configuration, '/sell/inventory/v1', sell_inventory.InventoryItemGroupApi, sell_inventory.ApiClient, 'create_or_replace_inventory_item_group', SellInventoryException, True, ['sell.inventory', 'inventory_item_group'], (body, content_language, content_type, inventory_item_group_key), **kwargs)  # noqa: E501
    ...
    def sell_inventory_bulk_migrate_listing(self, body, content_type, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_inventory.Configuration, '/sell/inventory/v1', sell_inventory.ListingApi, sell_inventory.ApiClient, 'bulk_migrate_listing', SellInventoryException, True, ['sell.inventory', 'listing'], (body, content_type), **kwargs)  # noqa: E501

    def sell_inventory_create_or_replace_sku_location_mapping(self, body, content_type, listing_id, sku, **kwargs):  # noqa: E501
        ...
        :return: None
        """
        return self._method_single(sell_inventory.Configuration, '/sell/inventory/v1', sell_inventory.ListingApi, sell_inventory.ApiClient, 'create_or_replace_sku_location_mapping', SellInventoryException, True, ['sell.inventory', 'listing'], (body, content_type, listing_id, sku), **kwargs)  # noqa: E501

    def sell_inventory_delete_sku_location_mapping(self, listing_id, sku, **kwargs):  # noqa: E501
        ...
        :return: None
        """
        return self._method_single(sell_inventory.Configuration, '/sell/inventory/v1', sell_inventory.ListingApi, sell_inventory.ApiClient, 'delete_sku_location_mapping', SellInventoryException, True, ['sell.inventory', 'listing'], (listing_id, sku), **kwargs)  # noqa: E501

    def sell_inventory_get_sku_location_mapping(self, listing_id, sku, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_inventory.Configuration, '/sell/inventory/v1', sell_inventory.ListingApi, sell_inventory.ApiClient, 'get_sku_location_mapping', SellInventoryException, True, ['sell.inventory', 'listing'], (listing_id, sku), **kwargs)  # noqa: E501

    def sell_inventory_create_inventory_location(self, body, content_type, merchant_location_key, **kwargs):  # noqa: E501
        ...
        :return: None
        """
        return self._method_single(sell_inventory.Configuration, '/sell/inventory/v1', sell_inventory.LocationApi, sell_inventory.ApiClient, 'create_inventory_location', SellInventoryException, True, ['sell.inventory', 'location'], (body, content_type, merchant_location_key), **kwargs)  # noqa: E501
    ...
    def sell_inventory_update_inventory_location(self, body, content_type, merchant_location_key, **kwargs):  # noqa: E501
        ...
        :return: None
        """
        return self._method_single(sell_inventory.Configuration, '/sell/inventory/v1', sell_inventory.LocationApi, sell_inventory.ApiClient, 'update_inventory_location', SellInventoryException, True, ['sell.inventory', 'location'], (body, content_type, merchant_location_key), **kwargs)  # noqa: E501

    def sell_inventory_bulk_create_offer(self, body, content_language, content_type, **kwargs):  # noqa: E501
        """bulk_create_offer  
        ...
        """
        return self._method_single(sell_inventory.Configuration, '/sell/inventory/v1', sell_inventory.OfferApi, sell_inventory.ApiClient, 'bulk_create_offer', SellInventoryException, True, ['sell.inventory', 'offer'], (body, content_language, content_type), **kwargs)  # noqa: E501

    def sell_inventory_bulk_publish_offer(self, body, content_type, **kwargs):  # noqa: E501
        """bulk_publish_offer  
        ...
        """
        return self._method_single(sell_inventory.Configuration, '/sell/inventory/v1', sell_inventory.OfferApi, sell_inventory.ApiClient, 'bulk_publish_offer', SellInventoryException, True, ['sell.inventory', 'offer'], (body, content_type), **kwargs)  # noqa: E501

    def sell_inventory_create_offer(self, body, content_language, content_type, **kwargs):  # noqa: E501
        """create_offer  
        ...
        """
        return self._method_single(sell_inventory.Configuration, '/sell/inventory/v1', sell_inventory.OfferApi, sell_inventory.ApiClient, 'create_offer', SellInventoryException, True, ['sell.inventory', 'offer'], (body, content_language, content_type), **kwargs)  # noqa: E501
    ...
    def sell_inventory_get_listing_fees(self, content_type, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_inventory.Configuration, '/sell/inventory/v1', sell_inventory.OfferApi, sell_inventory.ApiClient, 'get_listing_fees', SellInventoryException, True, ['sell.inventory', 'offer'], content_type, **kwargs)  # noqa: E501
    ...
    def sell_inventory_publish_offer_by_inventory_item_group(self, body, content_type, **kwargs):  # noqa: E501
        ...
        :return: PublishResponse
        """
        return self._method_single(sell_inventory.Configuration, '/sell/inventory/v1', sell_inventory.OfferApi, sell_inventory.ApiClient, 'publish_offer_by_inventory_item_group', SellInventoryException, True, ['sell.inventory', 'offer'], (body, content_type), **kwargs)  # noqa: E501

    def sell_inventory_update_offer(self, body, content_language, content_type, offer_id, **kwargs):  # noqa: E501
        """update_offer  
        ...
        :return: OfferResponse
        """
        return self._method_single(sell_inventory.Configuration, '/sell/inventory/v1', sell_inventory.OfferApi, sell_inventory.ApiClient, 'update_offer', SellInventoryException, True, ['sell.inventory', 'offer'], (body, content_language, content_type, offer_id), **kwargs)  # noqa: E501
    ...
    def sell_inventory_withdraw_offer_by_inventory_item_group(self, body, content_type, **kwargs):  # noqa: E501
        ...
        :return: None
        """
        return self._method_single(sell_inventory.Configuration, '/sell/inventory/v1', sell_inventory.OfferApi, sell_inventory.ApiClient, 'withdraw_offer_by_inventory_item_group', SellInventoryException, True, ['sell.inventory', 'offer'], (body, content_type), **kwargs)  # noqa: E501

    def sell_inventory_create_or_replace_product_compatibility(self, body, content_language, content_type, sku, **kwargs):  # noqa: E501
        ...
        :return: BaseResponse
        """
        return self._method_single(sell_inventory.Configuration, '/sell/inventory/v1', sell_inventory.ProductCompatibilityApi, sell_inventory.ApiClient, 'create_or_replace_product_compatibility', SellInventoryException, True, ['sell.inventory', 'product_compatibility'], (body, content_language, content_type, sku), **kwargs)  # noqa: E501
    ...
    def sell_logistics_create_from_shipping_quote(self, body, content_type, x_ebay_c_marketplace_id, **kwargs):  # noqa: E501
        ...
        :return: Shipment
        """
        return self._method_single(sell_logistics.Configuration, '/sell/logistics/v1_beta', sell_logistics.ShipmentApi, sell_logistics.ApiClient, 'create_from_shipping_quote', SellLogisticsException, True, ['sell.logistics', 'shipment'], (body, content_type, x_ebay_c_marketplace_id), **kwargs)  # noqa: E501

    def sell_logistics_download_label_file(self, shipment_id, accept, **kwargs):  # noqa: E501
        """download_label_file  
        ...
        :return: list[str]
        """
        return self._method_single(sell_logistics.Configuration, '/sell/logistics/v1_beta', sell_logistics.ShipmentApi, sell_logistics.ApiClient, 'download_label_file', SellLogisticsException, True, ['sell.logistics', 'shipment'], (shipment_id, accept), **kwargs)  # noqa: E501
    ...
    def sell_logistics_create_shipping_quote(self, body, x_ebay_c_marketplace_id, content_type, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_logistics.Configuration, '/sell/logistics/v1_beta', sell_logistics.ShippingQuoteApi, sell_logistics.ApiClient, 'create_shipping_quote', SellLogisticsException, True, ['sell.logistics', 'shipping_quote'], (body, x_ebay_c_marketplace_id, content_type), **kwargs)  # noqa: E501
    ...
    def sell_marketing_bulk_create_ads_by_inventory_reference(self, body, content_type, campaign_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.AdApi, sell_marketing.ApiClient, 'bulk_create_ads_by_inventory_reference', SellMarketingException, True, ['sell.marketing', 'ad'], (body, content_type, campaign_id), **kwargs)  # noqa: E501

    def sell_marketing_bulk_create_ads_by_listing_id(self, body, content_type, campaign_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.AdApi, sell_marketing.ApiClient, 'bulk_create_ads_by_listing_id', SellMarketingException, True, ['sell.marketing', 'ad'], (body, content_type, campaign_id), **kwargs)  # noqa: E501

    def sell_marketing_bulk_delete_ads_by_inventory_reference(self, body, content_type, campaign_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.AdApi, sell_marketing.ApiClient, 'bulk_delete_ads_by_inventory_reference', SellMarketingException, True, ['sell.marketing', 'ad'], (body, content_type, campaign_id), **kwargs)  # noqa: E501

    def sell_marketing_bulk_delete_ads_by_listing_id(self, body, content_type, campaign_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.AdApi, sell_marketing.ApiClient, 'bulk_delete_ads_by_listing_id', SellMarketingException, True, ['sell.marketing', 'ad'], (body, content_type, campaign_id), **kwargs)  # noqa: E501

    def sell_marketing_bulk_update_ads_bid_by_inventory_reference(self, body, content_type, campaign_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.AdApi, sell_marketing.ApiClient, 'bulk_update_ads_bid_by_inventory_reference', SellMarketingException, True, ['sell.marketing', 'ad'], (body, content_type, campaign_id), **kwargs)  # noqa: E501

    def sell_marketing_bulk_update_ads_bid_by_listing_id(self, body, content_type, campaign_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.AdApi, sell_marketing.ApiClient, 'bulk_update_ads_bid_by_listing_id', SellMarketingException, True, ['sell.marketing', 'ad'], (body, content_type, campaign_id), **kwargs)  # noqa: E501

    def sell_marketing_bulk_update_ads_status(self, body, content_type, campaign_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.AdApi, sell_marketing.ApiClient, 'bulk_update_ads_status', SellMarketingException, True, ['sell.marketing', 'ad'], (body, content_type, campaign_id), **kwargs)  # noqa: E501

    def sell_marketing_bulk_update_ads_status_by_listing_id(self, body, content_type, campaign_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.AdApi, sell_marketing.ApiClient, 'bulk_update_ads_status_by_listing_id', SellMarketingException, True, ['sell.marketing', 'ad'], (body, content_type, campaign_id), **kwargs)  # noqa: E501

    def sell_marketing_create_ad_by_listing_id(self, body, content_type, campaign_id, **kwargs):  # noqa: E501
        ...
        :return: object
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.AdApi, sell_marketing.ApiClient, 'create_ad_by_listing_id', SellMarketingException, True, ['sell.marketing', 'ad'], (body, content_type, campaign_id), **kwargs)  # noqa: E501

    def sell_marketing_create_ads_by_inventory_reference(self, body, content_type, campaign_id, **kwargs):  # noqa: E501
        ...
        :return: AdReferences
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.AdApi, sell_marketing.ApiClient, 'create_ads_by_inventory_reference', SellMarketingException, True, ['sell.marketing', 'ad'], (body, content_type, campaign_id), **kwargs)  # noqa: E501
    ...
    def sell_marketing_delete_ads_by_inventory_reference(self, body, content_type, campaign_id, **kwargs):  # noqa: E501
        ...
        :return: AdIds
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.AdApi, sell_marketing.ApiClient, 'delete_ads_by_inventory_reference', SellMarketingException, True, ['sell.marketing', 'ad'], (body, content_type, campaign_id), **kwargs)  # noqa: E501
    ...
    def sell_marketing_update_bid(self, body, content_type, ad_id, campaign_id, **kwargs):  # noqa: E501
        """update_bid  
        ...
        :return: None
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.AdApi, sell_marketing.ApiClient, 'update_bid', SellMarketingException, True, ['sell.marketing', 'ad'], (body, content_type, ad_id, campaign_id), **kwargs)  # noqa: E501

    def sell_marketing_create_ad_group(self, body, content_type, campaign_id, **kwargs):  # noqa: E501
        """create_ad_group  
        ...
        :return: object
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.AdGroupApi, sell_marketing.ApiClient, 'create_ad_group', SellMarketingException, True, ['sell.marketing', 'ad_group'], (body, content_type, campaign_id), **kwargs)  # noqa: E501
    ...
    def sell_marketing_suggest_bids(self, body, content_type, ad_group_id, campaign_id, **kwargs):  # noqa: E501
        """suggest_bids  
        ...
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.AdGroupApi, sell_marketing.ApiClient, 'suggest_bids', SellMarketingException, True, ['sell.marketing', 'ad_group'], (body, content_type, ad_group_id, campaign_id), **kwargs)  # noqa: E501

    def sell_marketing_suggest_keywords(self, content_type, ad_group_id, campaign_id, **kwargs):  # noqa: E501
        """suggest_keywords  
        ...
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.AdGroupApi, sell_marketing.ApiClient, 'suggest_keywords', SellMarketingException, True, ['sell.marketing', 'ad_group'], (content_type, ad_group_id, campaign_id), **kwargs)  # noqa: E501

    def sell_marketing_update_ad_group(self, body, content_type, ad_group_id, campaign_id, **kwargs):  # noqa: E501
        """update_ad_group  
        ...
        :return: None
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.AdGroupApi, sell_marketing.ApiClient, 'update_ad_group', SellMarketingException, True, ['sell.marketing', 'ad_group'], (body, content_type, ad_group_id, campaign_id), **kwargs)  # noqa: E501
    ...
    def sell_marketing_create_report_task(self, body, content_type, **kwargs):  # noqa: E501
        """create_report_task  
        ...
        :return: None
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.AdReportTaskApi, sell_marketing.ApiClient, 'create_report_task', SellMarketingException, True, ['sell.marketing', 'ad_report_task'], (body, content_type), **kwargs)  # noqa: E501
    ...
    def sell_marketing_clone_campaign(self, body, content_type, campaign_id, **kwargs):  # noqa: E501
        """clone_campaign  
        ...
        :return: object
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.CampaignApi, sell_marketing.ApiClient, 'clone_campaign', SellMarketingException, True, ['sell.marketing', 'campaign'], (body, content_type, campaign_id), **kwargs)  # noqa: E501

    def sell_marketing_create_campaign(self, body, content_type, **kwargs):  # noqa: E501
        """create_campaign  
        ...
        :return: object
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.CampaignApi, sell_marketing.ApiClient, 'create_campaign', SellMarketingException, True, ['sell.marketing', 'campaign'], (body, content_type), **kwargs)  # noqa: E501
    ...
    def sell_marketing_launch_campaign(self, campaign_id, **kwargs):  # noqa: E501
        ...
        :return: None
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.CampaignApi, sell_marketing.ApiClient, 'launch_campaign', SellMarketingException, True, ['sell.marketing', 'campaign'], campaign_id, **kwargs)  # noqa: E501
    ...
    def sell_marketing_setup_quick_campaign(self, body, content_type, **kwargs):  # noqa: E501
        ...
        :return: object
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.CampaignApi, sell_marketing.ApiClient, 'setup_quick_campaign', SellMarketingException, True, ['sell.marketing', 'campaign'], (body, content_type), **kwargs)  # noqa: E501

    def sell_marketing_suggest_budget(self, x_ebay_c_marketplace_id, **kwargs):  # noqa: E501
        """suggest_budget  
        ...
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.CampaignApi, sell_marketing.ApiClient, 'suggest_budget', SellMarketingException, True, ['sell.marketing', 'campaign'], x_ebay_c_marketplace_id, **kwargs)  # noqa: E501
    ...
    def sell_marketing_suggest_max_cpc(self, body, content_type, **kwargs):  # noqa: E501
        """suggest_max_cpc  
        ...
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.CampaignApi, sell_marketing.ApiClient, 'suggest_max_cpc', SellMarketingException, True, ['sell.marketing', 'campaign'], (body, content_type), **kwargs)  # noqa: E501

    def sell_marketing_update_ad_rate_strategy(self, body, content_type, campaign_id, **kwargs):  # noqa: E501
        ...
        :return: None
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.CampaignApi, sell_marketing.ApiClient, 'update_ad_rate_strategy', SellMarketingException, True, ['sell.marketing', 'campaign'], (body, content_type, campaign_id), **kwargs)  # noqa: E501

    def sell_marketing_update_bidding_strategy(self, body, content_type, campaign_id, **kwargs):  # noqa: E501
        ...
        :return: None
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.CampaignApi, sell_marketing.ApiClient, 'update_bidding_strategy', SellMarketingException, True, ['sell.marketing', 'campaign'], (body, content_type, campaign_id), **kwargs)  # noqa: E501

    def sell_marketing_update_campaign_budget(self, body, content_type, campaign_id, **kwargs):  # noqa: E501
        ...
        :return: object
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.CampaignApi, sell_marketing.ApiClient, 'update_campaign_budget', SellMarketingException, True, ['sell.marketing', 'campaign'], (body, content_type, campaign_id), **kwargs)  # noqa: E501

    def sell_marketing_update_campaign_identification(self, body, content_type, campaign_id, **kwargs):  # noqa: E501
        ...
        :return: None
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.CampaignApi, sell_marketing.ApiClient, 'update_campaign_identification', SellMarketingException, True, ['sell.marketing', 'campaign'], (body, content_type, campaign_id), **kwargs)  # noqa: E501

    def sell_marketing_create_email_campaign(self, body, x_ebay_c_marketplace_id, content_type, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.EmailCampaignApi, sell_marketing.ApiClient, 'create_email_campaign', SellMarketingException, True, ['sell.marketing', 'email_campaign'], (body, x_ebay_c_marketplace_id, content_type), **kwargs)  # noqa: E501

    def sell_marketing_delete_email_campaign(self, email_campaign_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.EmailCampaignApi, sell_marketing.ApiClient, 'delete_email_campaign', SellMarketingException, True, ['sell.marketing', 'email_campaign'], email_campaign_id, **kwargs)  # noqa: E501
    ...
    def sell_marketing_get_audiences(self, email_campaign_type, **kwargs):  # noqa: E501
        ...
        """
        return self._method_paged(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.EmailCampaignApi, sell_marketing.ApiClient, 'get_audiences', SellMarketingException, True, ['sell.marketing', 'email_campaign'], email_campaign_type, **kwargs)  # noqa: E501

    def sell_marketing_get_email_campaign(self, email_campaign_id, **kwargs):  # noqa: E501
        """get_email_campaign  
        ...
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.EmailCampaignApi, sell_marketing.ApiClient, 'get_email_campaign', SellMarketingException, True, ['sell.marketing', 'email_campaign'], email_campaign_id, **kwargs)  # noqa: E501
    ...
    def sell_marketing_get_email_campaigns(self, **kwargs):  # noqa: E501
        ...
        """
        return self._method_paged(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.EmailCampaignApi, sell_marketing.ApiClient, 'get_email_campaigns', SellMarketingException, True, ['sell.marketing', 'email_campaign'], None, **kwargs)  # noqa: E501

    def sell_marketing_get_email_preview(self, email_campaign_id, **kwargs):  # noqa: E501
        """get_email_preview  
        ...
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.EmailCampaignApi, sell_marketing.ApiClient, 'get_email_preview', SellMarketingException, True, ['sell.marketing', 'email_campaign'], email_campaign_id, **kwargs)  # noqa: E501

    def sell_marketing_get_email_report(self, end_date, start_date, **kwargs):  # noqa: E501
        """get_email_report  
        ...
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.EmailCampaignApi, sell_marketing.ApiClient, 'get_email_report', SellMarketingException, True, ['sell.marketing', 'email_campaign'], (end_date, start_date), **kwargs)  # noqa: E501

    def sell_marketing_update_email_campaign(self, body, content_type, email_campaign_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.EmailCampaignApi, sell_marketing.ApiClient, 'update_email_campaign', SellMarketingException, True, ['sell.marketing', 'email_campaign'], (body, content_type, email_campaign_id), **kwargs)  # noqa: E501

    def sell_marketing_create_item_price_markdown_promotion(self, content_type, **kwargs):  # noqa: E501
        ...
        :return: object
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.ItemPriceMarkdownApi, sell_marketing.ApiClient, 'create_item_price_markdown_promotion', SellMarketingException, True, ['sell.marketing', 'item_price_markdown'], content_type, **kwargs)  # noqa: E501
    ...
    def sell_marketing_update_item_price_markdown_promotion(self, content_type, promotion_id, **kwargs):  # noqa: E501
        ...
        :return: object
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.ItemPriceMarkdownApi, sell_marketing.ApiClient, 'update_item_price_markdown_promotion', SellMarketingException, True, ['sell.marketing', 'item_price_markdown'], (content_type, promotion_id), **kwargs)  # noqa: E501

    def sell_marketing_create_item_promotion(self, content_type, **kwargs):  # noqa: E501
        ...
        :return: BaseResponse
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.ItemPromotionApi, sell_marketing.ApiClient, 'create_item_promotion', SellMarketingException, True, ['sell.marketing', 'item_promotion'], content_type, **kwargs)  # noqa: E501
    ...
    def sell_marketing_update_item_promotion(self, content_type, promotion_id, **kwargs):  # noqa: E501
        ...
        :return: BaseResponse
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.ItemPromotionApi, sell_marketing.ApiClient, 'update_item_promotion', SellMarketingException, True, ['sell.marketing', 'item_promotion'], (content_type, promotion_id), **kwargs)  # noqa: E501

    def sell_marketing_bulk_create_keyword(self, body, content_type, campaign_id, **kwargs):  # noqa: E501
        """bulk_create_keyword  
        ...
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.KeywordApi, sell_marketing.ApiClient, 'bulk_create_keyword', SellMarketingException, True, ['sell.marketing', 'keyword'], (body, content_type, campaign_id), **kwargs)  # noqa: E501

    def sell_marketing_bulk_update_keyword(self, body, content_type, campaign_id, **kwargs):  # noqa: E501
        """bulk_update_keyword  
        ...
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.KeywordApi, sell_marketing.ApiClient, 'bulk_update_keyword', SellMarketingException, True, ['sell.marketing', 'keyword'], (body, content_type, campaign_id), **kwargs)  # noqa: E501

    def sell_marketing_create_keyword(self, body, content_type, campaign_id, **kwargs):  # noqa: E501
        """create_keyword  
        ...
        :return: object
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.KeywordApi, sell_marketing.ApiClient, 'create_keyword', SellMarketingException, True, ['sell.marketing', 'keyword'], (body, content_type, campaign_id), **kwargs)  # noqa: E501
    ...
    def sell_marketing_update_keyword(self, body, content_type, campaign_id, keyword_id, **kwargs):  # noqa: E501
        """update_keyword  
        ...
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.KeywordApi, sell_marketing.ApiClient, 'update_keyword', SellMarketingException, True, ['sell.marketing', 'keyword'], (body, content_type, campaign_id, keyword_id), **kwargs)  # noqa: E501

    def sell_marketing_bulk_create_negative_keyword(self, body, content_type, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.NegativeKeywordApi, sell_marketing.ApiClient, 'bulk_create_negative_keyword', SellMarketingException, True, ['sell.marketing', 'negative_keyword'], (body, content_type), **kwargs)  # noqa: E501

    def sell_marketing_bulk_update_negative_keyword(self, body, content_type, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.NegativeKeywordApi, sell_marketing.ApiClient, 'bulk_update_negative_keyword', SellMarketingException, True, ['sell.marketing', 'negative_keyword'], (body, content_type), **kwargs)  # noqa: E501

    def sell_marketing_create_negative_keyword(self, body, content_type, **kwargs):  # noqa: E501
        ...
        :return: object
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.NegativeKeywordApi, sell_marketing.ApiClient, 'create_negative_keyword', SellMarketingException, True, ['sell.marketing', 'negative_keyword'], (body, content_type), **kwargs)  # noqa: E501
    ...
    def sell_marketing_update_negative_keyword(self, body, content_type, negative_keyword_id, **kwargs):  # noqa: E501
        ...
        :return: None
        """
        return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.NegativeKeywordApi, sell_marketing.ApiClient, 'update_negative_keyword', SellMarketingException, True, ['sell.marketing', 'negative_keyword'], (body, content_type, negative_keyword_id), **kwargs)  # noqa: E501
    ...
    def sell_metadata_get_compatibilities_by_specification(self, x_ebay_c_marketplace_id, content_type, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_metadata.Configuration, '/sell/metadata/v1', sell_metadata.CompatibilitiesApi, sell_metadata.ApiClient, 'get_compatibilities_by_specification', SellMetadataException, False, ['sell.metadata', 'compatibilities'], (x_ebay_c_marketplace_id, content_type), **kwargs)  # noqa: E501

    def sell_metadata_get_compatibility_property_names(self, x_ebay_c_marketplace_id, content_type, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_metadata.Configuration, '/sell/metadata/v1', sell_metadata.CompatibilitiesApi, sell_metadata.ApiClient, 'get_compatibility_property_names', SellMetadataException, False, ['sell.metadata', 'compatibilities'], (x_ebay_c_marketplace_id, content_type), **kwargs)  # noqa: E501

    def sell_metadata_get_compatibility_property_values(self, x_ebay_c_marketplace_id, content_type, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_metadata.Configuration, '/sell/metadata/v1', sell_metadata.CompatibilitiesApi, sell_metadata.ApiClient, 'get_compatibility_property_values', SellMetadataException, False, ['sell.metadata', 'compatibilities'], (x_ebay_c_marketplace_id, content_type), **kwargs)  # noqa: E501

    def sell_metadata_get_multi_compatibility_property_values(self, x_ebay_c_marketplace_id, content_type, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_metadata.Configuration, '/sell/metadata/v1', sell_metadata.CompatibilitiesApi, sell_metadata.ApiClient, 'get_multi_compatibility_property_values', SellMetadataException, False, ['sell.metadata', 'compatibilities'], (x_ebay_c_marketplace_id, content_type), **kwargs)  # noqa: E501

    def sell_metadata_get_product_compatibilities(self, x_ebay_c_marketplace_id, content_type, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_metadata.Configuration, '/sell/metadata/v1', sell_metadata.CompatibilitiesApi, sell_metadata.ApiClient, 'get_product_compatibilities', SellMetadataException, False, ['sell.metadata', 'compatibilities'], (x_ebay_c_marketplace_id, content_type), **kwargs)  # noqa: E501
    ...
    def sell_metadata_get_category_policies(self, marketplace_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_metadata.Configuration, '/sell/metadata/v1', sell_metadata.MarketplaceApi, sell_metadata.ApiClient, 'get_category_policies', SellMetadataException, False, ['sell.metadata', 'marketplace'], marketplace_id, **kwargs)  # noqa: E501

    def sell_metadata_get_classified_ad_policies(self, marketplace_id, **kwargs):  # noqa: E501
        ...
        :param str marketplace_id: This path parameter specifies the eBay marketplace for which policy information is retrieved.See MarketplaceIdEnum for a list of supported eBay marketplace ID values. (required)
        :param str filter: This query parameter limits the response by only returning metadata for the specified leaf categories. Supply the categoryId for one or more leaf categories. You can verify if a category is a leaf category by using the Taxonomy API and looking for a \"leafCategory\": true tag.   The parameter takes a list of categoryId values and you can specify up to 50 separate category IDs. Separate multiple values with a pipe character ('|'). If you specify more than 50 categoryId values, eBay returns the policies for the first 50 IDs and a warning that not all categories were returned.Example:filter=categoryIds:{3767|171784}
        :param str accept_language: This header is required to retrieve metadata for the French Canada, French Belgium, and Dutch Belgium marketplaces.Follow the instructions below to retrieve metadata for these three marketplaces:French Belgium: Set the marketplace_id path parameter value to EBAY_BE, and include the Accept-Language header with a value of fr-BE.Dutch Belgium: Set the marketplace_id path parameter value to EBAY_BE, and include the Accept-Language header with a value of nl-BE.French Canada: Set the marketplace_id path parameter value to EBAY_CA, and include the Accept-Language header with a value of fr-CA.Note: If EBAY_CA is set as the marketplace_id path parameter and the Accept-Language header is not used, the marketplace will default to the English Canada marketplace.
        :return: ClassifiedAdPolicyResponse
        """
        return self._method_single(sell_metadata.Configuration, '/sell/metadata/v1', sell_metadata.MarketplaceApi, sell_metadata.ApiClient, 'get_classified_ad_policies', SellMetadataException, False, ['sell.metadata', 'marketplace'], marketplace_id, **kwargs)  # noqa: E501

    def sell_metadata_get_currencies(self, marketplace_id, **kwargs):  # noqa: E501
        """get_currencies  
        ...
        :param str marketplace_id: This path parameter specifies the eBay marketplace for which currency information is retrieved.See the MarketplaceIdEnum type for a list of supported eBay marketplace ID values. (required)
        ...
        """
        return self._method_single(sell_metadata.Configuration, '/sell/metadata/v1', sell_metadata.MarketplaceApi, sell_metadata.ApiClient, 'get_currencies', SellMetadataException, False, ['sell.metadata', 'marketplace'], marketplace_id, **kwargs)  # noqa: E501
    ...
    def sell_metadata_get_listing_type_policies(self, marketplace_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_metadata.Configuration, '/sell/metadata/v1', sell_metadata.MarketplaceApi, sell_metadata.ApiClient, 'get_listing_type_policies', SellMetadataException, False, ['sell.metadata', 'marketplace'], marketplace_id, **kwargs)  # noqa: E501

    def sell_metadata_get_motors_listing_policies(self, marketplace_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_metadata.Configuration, '/sell/metadata/v1', sell_metadata.MarketplaceApi, sell_metadata.ApiClient, 'get_motors_listing_policies', SellMetadataException, False, ['sell.metadata', 'marketplace'], marketplace_id, **kwargs)  # noqa: E501
    ...
    def sell_metadata_get_product_safety_labels(self, marketplace_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_metadata.Configuration, '/sell/metadata/v1', sell_metadata.MarketplaceApi, sell_metadata.ApiClient, 'get_product_safety_labels', SellMetadataException, False, ['sell.metadata', 'marketplace'], marketplace_id, **kwargs)  # noqa: E501

    def sell_metadata_get_regulatory_policies(self, marketplace_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_metadata.Configuration, '/sell/metadata/v1', sell_metadata.MarketplaceApi, sell_metadata.ApiClient, 'get_regulatory_policies', SellMetadataException, False, ['sell.metadata', 'marketplace'], marketplace_id, **kwargs)  # noqa: E501
    ...
    def sell_metadata_get_shipping_policies(self, marketplace_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_metadata.Configuration, '/sell/metadata/v1', sell_metadata.MarketplaceApi, sell_metadata.ApiClient, 'get_shipping_policies', SellMetadataException, False, ['sell.metadata', 'marketplace'], marketplace_id, **kwargs)  # noqa: E501

    def sell_metadata_get_site_visibility_policies(self, marketplace_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_metadata.Configuration, '/sell/metadata/v1', sell_metadata.MarketplaceApi, sell_metadata.ApiClient, 'get_site_visibility_policies', SellMetadataException, False, ['sell.metadata', 'marketplace'], marketplace_id, **kwargs)  # noqa: E501

    def sell_metadata_get_exclude_shipping_locations(self, marketplace_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_metadata.Configuration, '/sell/metadata/v1', sell_metadata.ShippingmarketplaceApi, sell_metadata.ApiClient, 'get_exclude_shipping_locations', SellMetadataException, False, ['sell.metadata', 'shippingmarketplace'], marketplace_id, **kwargs)  # noqa: E501
    ...
    def sell_metadata_get_handling_times(self, marketplace_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_metadata.Configuration, '/sell/metadata/v1', sell_metadata.ShippingmarketplaceApi, sell_metadata.ApiClient, 'get_handling_times', SellMetadataException, False, ['sell.metadata', 'shippingmarketplace'], marketplace_id, **kwargs)  # noqa: E501

    def sell_metadata_get_shipping_carriers(self, marketplace_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_metadata.Configuration, '/sell/metadata/v1', sell_metadata.ShippingmarketplaceApi, sell_metadata.ApiClient, 'get_shipping_carriers', SellMetadataException, False, ['sell.metadata', 'shippingmarketplace'], marketplace_id, **kwargs)  # noqa: E501

    def sell_metadata_get_shipping_locations(self, marketplace_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_metadata.Configuration, '/sell/metadata/v1', sell_metadata.ShippingmarketplaceApi, sell_metadata.ApiClient, 'get_shipping_locations', SellMetadataException, False, ['sell.metadata', 'shippingmarketplace'], marketplace_id, **kwargs)  # noqa: E501

    def sell_metadata_get_shipping_services(self, marketplace_id, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_metadata.Configuration, '/sell/metadata/v1', sell_metadata.ShippingmarketplaceApi, sell_metadata.ApiClient, 'get_shipping_services', SellMetadataException, False, ['sell.metadata', 'shippingmarketplace'], marketplace_id, **kwargs)  # noqa: E501
    ...
    def sell_negotiation_send_offer_to_interested_buyers(self, x_ebay_c_marketplace_id, content_type, **kwargs):  # noqa: E501
        ...
        """
        return self._method_single(sell_negotiation.Configuration, '/sell/negotiation/v1', sell_negotiation.OfferApi, sell_negotiation.ApiClient, 'send_offer_to_interested_buyers', SellNegotiationException, True, ['sell.negotiation', 'offer'], (x_ebay_c_marketplace_id, content_type), **kwargs)  # noqa: E501
