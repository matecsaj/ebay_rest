...
class API(metaclass=Multiton):
    ...
    def buy_browse_check_compatibility(self, content_type, item_id, **kwargs):  # noqa: E501
        ...
        :param str x_ebay_c_marketplace_id: The ID of the eBay marketplace you want to use.  Note:  This value is case sensitive.For example:   X-EBAY-C-MARKETPLACE-ID = EBAY_US  For a list of supported sites see, API Restrictions.
    ...
    def buy_browse_get_item_by_legacy_id(self, legacy_item_id, **kwargs):  # noqa: E501
        ...
        :param str fieldgroups: This field lets you control what is returned in the response. If you do not set this field, the method returns all the details of the item. Multiple fieldgroups can be set. Valid Values:   PRODUCT - This adds the additionalImages, additionalProductIdentities, aspectGroups, description, gtins, image, and title fields to the response, which describe the item's product.  See Product for more information about these fields.ADDITIONAL_SELLER_DETAILS - This adds the userId field to the response. This field provides the seller's user ID. See userId for more information about this field.
    ...
    def buy_browse_get_items_by_item_group(self, item_group_id, **kwargs):  # noqa: E501
        ...
        :param str fieldgroups: This field lets you control what is returned in the response. If you do not set this field, the method returns all the details of the item.Valid Values:ADDITIONAL_SELLER_DETAILS - This adds the userId field to the response. This field provides the seller's user ID. See userId for more information about this field.
        :param str x_ebay_c_enduserctx: This header is required to support revenue sharing for eBay Partner Network and to improve the accuracy of shipping and delivery time estimations.For additional information, refer to Use request headers.
        :param str x_ebay_c_marketplace_id: This header identifies the seller's eBay marketplace. It is required for all marketplaces outside of the US.Note: If a marketplace ID value is not provided, the default value of EBAY_US is used.See HTTP request headers for the marketplace ID values.
        :return: ItemGroup
        """
    ...
    def buy_deal_get_deal_items(self, x_ebay_c_marketplace_id, **kwargs):  # noqa: E501
        ...
        :param str x_ebay_c_marketplace_id: This header identifies the eBay marketplace.See HTTP request headers for the marketplace ID values. (required)
        ...
        :param str x_ebay_c_enduserctx: This header is needed to support revenue sharing for eBay Partner Network and to improve the accuracy of shipping and delivery time estimations.For additional information, refer to Use request headers.
    ...
    def buy_marketplace_insights_search(self, x_ebay_c_marketplace_id, **kwargs):  # noqa: E501
        """search  
        ...
        """
        try:
            return self._method_paged(buy_marketplace_insights.Configuration, '/buy/marketplace_insights/v1_beta', buy_marketplace_insights.ItemSalesApi, buy_marketplace_insights.ApiClient, 'search', BuyMarketplaceInsightsException, False, ['buy.marketplace.insights', 'item_sales'], x_ebay_c_marketplace_id, **kwargs)  # noqa: E501
        except Error:
            raise
    ...
    def buy_order_apply_guest_coupon(self, x_ebay_c_marketplace_id, content_type, checkout_session_id, **kwargs):  # noqa: E501
        ...
        :param str x_ebay_c_marketplace_id: This header identifies the eBay marketplace where the order will occur. For this method, this value must match the X-EBAY-C-MARKETPLACE-ID used when the associated checkout session was created. See HTTP request headers for the marketplace ID values. (required)
        :param str content_type: This header indicates the format of the request body provided by the client. Its value should be set to application/json.  For more information, refer to HTTP request headers. (required)
    ...
    def buy_order_get_guest_purchase_order(self, purchase_order_id, **kwargs):  # noqa: E501
        ...
        :param str x_ebay_c_marketplace_id: This header identifies the eBay marketplace where the order will occur. For this method, this value must match the X-EBAY-C-MARKETPLACE-ID used when the associated checkout session was created. See HTTP request headers for the marketplace ID values.
        :param str x_ebay_c_enduserctx: This header is used to specify the deviceId for the device/user attempting to make the call. It contains an alphanumeric string that allows a payment gateway to track an API call attempt and confirm that it is a verified payment attempt by a device/user.
    ...
    def commerce_notification_delete_subscription_filter(self, subscription_id, filter_id, **kwargs):  # noqa: E501
        ...
        """
        try:
            return self._method_single(commerce_notification.Configuration, '/commerce/notification/v1', commerce_notification.SubscriptionApi, commerce_notification.ApiClient, 'delete_subscription_filter', CommerceNotificationException, False, ['commerce.notification', 'subscription'], (subscription_id, filter_id), **kwargs)  # noqa: E501
        except Error:
            raise
    ...
    def commerce_notification_get_subscription_filter(self, subscription_id, filter_id, **kwargs):  # noqa: E501
        ...
        """
        try:
            return self._method_single(commerce_notification.Configuration, '/commerce/notification/v1', commerce_notification.SubscriptionApi, commerce_notification.ApiClient, 'get_subscription_filter', CommerceNotificationException, False, ['commerce.notification', 'subscription'], (subscription_id, filter_id), **kwargs)  # noqa: E501
        except Error:
            raise
    ...
    def commerce_taxonomy_get_category_subtree(self, category_id, category_tree_id, **kwargs):  # noqa: E501
        ...
        :param str accept_encoding: This header indicates the compression-encoding algorithms the client accepts for the response. This value should be set to application/gzip.  For more information, refer to HTTP request headers.
    ...
    def sell_account_get_advertising_eligibility(self, x_ebay_c_marketplace_id, **kwargs):  # noqa: E501
        ...
        :param str x_ebay_c_marketplace_id: The unique identifier of the eBay marketplace for which the seller eligibility status shall be checked. This header is required or the call will fail.See the MarketplaceIdEnum type for the supported marketplace ID values. (required)
        :param str program_types: A comma-separated list of eBay advertising programs for which eligibility status will be returned. See the  AdvertisingProgramEnum type for a list of supported values.If no programs are specified, the results will be returned for all programs.
    ...
    def sell_account_create_custom_policy(self, body, content_type, **kwargs):  # noqa: E501
        """create_custom_policy  

        This method creates a new custom policy in which a seller specifies their terms for complying with local governmental regulations. Two Custom Policy types are supported: Product Compliance (PRODUCT_COMPLIANCE) Take back (TAKE_BACK)Each Custom Policy targets a policyType. Multiple policies may be created as follows: Product Compliance: a maximum of 60 policies per seller may be created Take back: a maximum of 18 policies per seller may be createdA successful create policy call returns an HTTP status code of 201 Created with the system-generated policy ID included in the Location response header.Product Compliance PolicyProduct Compliance policies disclose product information as required for regulatory compliance.Note: A maximum of 60 Product Compliance policies per seller may be created.  Take back PolicyTake back policies describe the seller's legal obligation to take back a previously purchased item when the buyer purchases a new one.Note: A maximum of 18 Take back policies per seller may be created.Note: Custom policies are no longer coupled with a specific eBay marketplace, so the EBAY-C-MARKETPLACE-ID request header is no longer needed or relevant for any of the Custom Policy methods.  
        ...
        """
        try:
            return self._method_single(sell_account.Configuration, '/sell/account/v1', sell_account.CustomPolicyApi, sell_account.ApiClient, 'create_custom_policy', SellAccountException, True, ['sell.account', 'custom_policy'], (body, content_type), **kwargs)  # noqa: E501
        except Error:
            raise

    def sell_account_get_custom_policies(self, **kwargs):  # noqa: E501
        """get_custom_policies  

        This method retrieves the list of custom policies specified by the policy_types query parameter.Note: Custom policies are no longer coupled with a specific eBay marketplace, so the EBAY-C-MARKETPLACE-ID request header is no longer needed or relevant for any of the Custom Policy methods.  
        ...
        """
        try:
            return self._method_single(sell_account.Configuration, '/sell/account/v1', sell_account.CustomPolicyApi, sell_account.ApiClient, 'get_custom_policies', SellAccountException, True, ['sell.account', 'custom_policy'], None, **kwargs)  # noqa: E501
        except Error:
            raise

    def sell_account_get_custom_policy(self, custom_policy_id, **kwargs):  # noqa: E501
        """get_custom_policy  

        This method retrieves the custom policy specified by the custom_policy_id path parameter.Note: Custom policies are no longer coupled with a specific eBay marketplace, so the EBAY-C-MARKETPLACE-ID request header is no longer needed or relevant for any of the Custom Policy methods.  

        :param str custom_policy_id: This path parameter is the unique identifier of the custom policy to retrieve. This ID can be retrieved for a custom policy by using the getCustomPolicies method. (required)
        :return: CustomPolicy
        """
        try:
            return self._method_single(sell_account.Configuration, '/sell/account/v1', sell_account.CustomPolicyApi, sell_account.ApiClient, 'get_custom_policy', SellAccountException, True, ['sell.account', 'custom_policy'], custom_policy_id, **kwargs)  # noqa: E501
        except Error:
            raise

    def sell_account_update_custom_policy(self, body, content_type, custom_policy_id, **kwargs):  # noqa: E501
        ...
        """
        try:
            return self._method_single(sell_account.Configuration, '/sell/account/v1', sell_account.CustomPolicyApi, sell_account.ApiClient, 'update_custom_policy', SellAccountException, True, ['sell.account', 'custom_policy'], (body, content_type, custom_policy_id), **kwargs)  # noqa: E501
        except Error:
            raise

    def sell_account_create_fulfillment_policy(self, body, content_type, **kwargs):  # noqa: E501
        ...
        """
        try:
            return self._method_single(sell_account.Configuration, '/sell/account/v1', sell_account.FulfillmentPolicyApi, sell_account.ApiClient, 'create_fulfillment_policy', SellAccountException, True, ['sell.account', 'fulfillment_policy'], (body, content_type), **kwargs)  # noqa: E501
        except Error:
            raise
    ...
    def sell_account_delete_fulfillment_policy(self, fulfillment_policy_id, **kwargs):  # noqa: E501
        ...
        :param str fulfillment_policy_id: This path parameter specifies the ID of the fulfillment policy to delete. This ID can be retrieved for a fulfillment policy by using the getFulfillmentPolicies method. (required)
        :return: None
        """
        try:
    ...
    def sell_account_get_fulfillment_policy(self, fulfillment_policy_id, **kwargs):  # noqa: E501
        ...
        :param str fulfillment_policy_id: This path parameter specifies the ID of the fulfillment policy you want to retrieve. This ID can be retrieved for a fulfillment policy by using the getFulfillmentPolicies method. (required)
    ...
    def sell_account_get_fulfillment_policy_by_name(self, marketplace_id, name, **kwargs):  # noqa: E501
        ...
        :param str name: This query parameter specifies the seller-defined name of the fulfillment policy you want to retrieve.This value can be retrieved for a fulfillment policy by using the getFulfillmentPolicies method. (required)
        :return: FulfillmentPolicy
        """
        try:
    ...
    def sell_account_update_fulfillment_policy(self, body, content_type, fulfillment_policy_id, **kwargs):  # noqa: E501
        ...
        :param str content_type: This header indicates the format of the request body provided by the client. Its value should be set to application/json.  For more information, refer to HTTP request headers. (required)
        :param str fulfillment_policy_id: This path parameter specifies the ID of the fulfillment policy you want to update.This ID can be retrieved for a specific fulfillment policy by using the getFulfillmentPolicies method. (required)
        :return: SetFulfillmentPolicyResponse
        """
        try:
            return self._method_single(sell_account.Configuration, '/sell/account/v1', sell_account.FulfillmentPolicyApi, sell_account.ApiClient, 'update_fulfillment_policy', SellAccountException, True, ['sell.account', 'fulfillment_policy'], (body, content_type, fulfillment_policy_id), **kwargs)  # noqa: E501
        except Error:
            raise
    ...
    def sell_account_create_payment_policy(self, body, content_type, **kwargs):  # noqa: E501
        ...
        """
        try:
            return self._method_single(sell_account.Configuration, '/sell/account/v1', sell_account.PaymentPolicyApi, sell_account.ApiClient, 'create_payment_policy', SellAccountException, True, ['sell.account', 'payment_policy'], (body, content_type), **kwargs)  # noqa: E501
        except Error:
            raise
    ...
    def sell_account_delete_payment_policy(self, payment_policy_id, **kwargs):  # noqa: E501
        ...
        :param str payment_policy_id: This path parameter specifies the unique identifier of the payment policy you want to delete. This ID can be retrieved for a payment policy by using the getPaymentPolices method. (required)
        :return: None
        """
        try:
    ...
    def sell_account_get_payment_policy(self, payment_policy_id, **kwargs):  # noqa: E501
        ...
        :param str payment_policy_id: This path parameter specifies the ID of the payment policy you want to retrieve.  This ID can be retrieved for a payment policy by using the getPaymentPolices method. (required)
    ...
    def sell_account_get_payment_policy_by_name(self, marketplace_id, name, **kwargs):  # noqa: E501
        ...
        :param str marketplace_id: This query parameter specifies the eBay marketplace of the policy you want to retrieve. For implementation help, refer to eBay API documentation at https://developer.ebay.com/api-docs/sell/account/types/ba:MarketplaceIdEnum (required)
        :param str name: This query parameter specifies the seller-defined name of the payment policy you want to retrieve. This value can be retrieved for a payment policy by using the getPaymentPolicies method. (required)
        :return: PaymentPolicy
        """
        try:
    ...
    def sell_account_update_payment_policy(self, body, content_type, payment_policy_id, **kwargs):  # noqa: E501
        ...
        :param PaymentPolicyRequest body: Payment policy request (required)
        :param str content_type: This header indicates the format of the request body provided by the client. Its value should be set to application/json.  For more information, refer to HTTP request headers. (required)
        :param str payment_policy_id: This path parameter specifies the ID of the payment policy you want to update.  This ID can be retrieved for a payment policy by using the getPaymentPolices method. (required)
        :return: SetPaymentPolicyResponse
        """
        try:
            return self._method_single(sell_account.Configuration, '/sell/account/v1', sell_account.PaymentPolicyApi, sell_account.ApiClient, 'update_payment_policy', SellAccountException, True, ['sell.account', 'payment_policy'], (body, content_type, payment_policy_id), **kwargs)  # noqa: E501
        except Error:
            raise
    ...
    def sell_account_opt_in_to_program(self, body, content_type, **kwargs):  # noqa: E501
        """opt_in_to_program  
        ...
        """
        try:
            return self._method_single(sell_account.Configuration, '/sell/account/v1', sell_account.ProgramApi, sell_account.ApiClient, 'opt_in_to_program', SellAccountException, True, ['sell.account', 'program'], (body, content_type), **kwargs)  # noqa: E501
        except Error:
            raise

    def sell_account_opt_out_of_program(self, body, content_type, **kwargs):  # noqa: E501
        """opt_out_of_program  
        ...
        """
        try:
            return self._method_single(sell_account.Configuration, '/sell/account/v1', sell_account.ProgramApi, sell_account.ApiClient, 'opt_out_of_program', SellAccountException, True, ['sell.account', 'program'], (body, content_type), **kwargs)  # noqa: E501
        except Error:
            raise
    ...
    def sell_account_create_return_policy(self, body, content_type, **kwargs):  # noqa: E501
        ...
        """
        try:
            return self._method_single(sell_account.Configuration, '/sell/account/v1', sell_account.ReturnPolicyApi, sell_account.ApiClient, 'create_return_policy', SellAccountException, True, ['sell.account', 'return_policy'], (body, content_type), **kwargs)  # noqa: E501
        except Error:
            raise
    ...
    def sell_account_delete_return_policy(self, return_policy_id, **kwargs):  # noqa: E501
        ...
        :param str return_policy_id: This path parameter specifies the unique identifier of the return policy you want to delete. This ID can be retrieved for a return policy by using the getReturnPolicies method. (required)
        :return: None
        """
        try:
    ...
    def sell_account_get_return_policy(self, return_policy_id, **kwargs):  # noqa: E501
        ...
        :param str return_policy_id: This path parameter specifies the unique identifier of the return policy you want to retrieve.  This ID can be retrieved for a return policy by using the getReturnPolicies method. (required)
        :return: ReturnPolicy
        """
        try:
    ...
    def sell_account_get_return_policy_by_name(self, marketplace_id, name, **kwargs):  # noqa: E501
        ...
        :param str marketplace_id: This query parameter specifies the ID of the eBay marketplace of the policy you want to retrieve. For implementation help, refer to eBay API documentation at https://developer.ebay.com/api-docs/sell/account/types/ba:MarketplaceIdEnum (required)
        :param str name: This query parameter specifies the seller-defined name of the return policy you want to retrieve. This value can be retrieved for a return policy by using the getReturnPolicies method. (required)
        :return: ReturnPolicy
        """
        try:
    ...
    def sell_account_update_return_policy(self, body, content_type, return_policy_id, **kwargs):  # noqa: E501
        ...
        :param str content_type: This header indicates the format of the request body provided by the client. Its value should be set to application/json.  For more information, refer to HTTP request headers. (required)
        :param str return_policy_id: This path parameter specifies the ID of the return policy you want to update.  This ID can be retrieved for a return policy by using the getReturnPolicies method. (required)
        :return: SetReturnPolicyResponse
        """
        try:
            return self._method_single(sell_account.Configuration, '/sell/account/v1', sell_account.ReturnPolicyApi, sell_account.ApiClient, 'update_return_policy', SellAccountException, True, ['sell.account', 'return_policy'], (body, content_type, return_policy_id), **kwargs)  # noqa: E501
        except Error:
            raise

    def sell_account_create_or_replace_sales_tax(self, body, content_type, country_code, jurisdiction_id, **kwargs):  # noqa: E501
        """create_or_replace_sales_tax  

        This method creates or updates a sales tax table entry for a jurisdiction. Specify the tax table entry you want to configure using the two path parameters: countryCode and jurisdictionId.  A tax table entry for a jurisdiction is comprised of two fields: one for the jurisdiction's sales-tax rate and another that's a boolean value indicating whether or not shipping and handling are taxed in the jurisdiction.  You can set up tax tables for countries that support different tax jurisdictions. Currently, only Canada and the US support separate tax jurisdictions. If you sell into any of these countries, you can set up tax tables for any of the country's jurisdictions. Retrieve valid jurisdiction IDs using getSalesTaxJurisdictions in the Metadata API.  For details on using this call, see Establishing sales-tax tables. Important! In the US, eBay now 'collects and remits' sales tax for every US state except for Missouri (and a few US territories), so sellers can no longer configure sales tax rates for any states except Missouri. With eBay 'collect and remit', eBay calculates the sales tax, collects the sales tax from the buyer, and remits the sales tax to the tax authorities at the buyer's location.  
        ...
        :param str jurisdiction_id: This path parameter specifies the ID of the tax jurisdiction for the table entry you want to create.  Valid jurisdiction IDs can be retrieved using the getSalesTaxJurisdiction method of the Metadata API. (required)
        :return: None
        """
        try:
            return self._method_single(sell_account.Configuration, '/sell/account/v1', sell_account.SalesTaxApi, sell_account.ApiClient, 'create_or_replace_sales_tax', SellAccountException, True, ['sell.account', 'sales_tax'], (body, content_type, country_code, jurisdiction_id), **kwargs)  # noqa: E501
        except Error:
            raise
    ...
    def sell_account_delete_sales_tax(self, country_code, jurisdiction_id, **kwargs):  # noqa: E501
        ...
        :param str jurisdiction_id: This path parameter specifies the ID of the sales tax jurisdiction whose table entry you want to delete.  Valid jurisdiction IDs can be retrieved using the getSalesTaxJurisdiction method of the Metadata API. (required)
        :return: None
        """
        try:
    ...
    def sell_account_get_sales_tax(self, country_code, jurisdiction_id, **kwargs):  # noqa: E501
        ...
        :param str jurisdiction_id: This path parameter specifies the ID of the sales tax jurisdiction for the tax table entry you want to retrieve.  Valid jurisdiction IDs can be retrieved using the getSalesTaxJurisdiction method of the Metadata API. (required)
        :return: SalesTax
        """
        try:
    ...
    def sell_compliance_suppress_violation(self, body, content_type, x_ebay_c_marketplace_id, **kwargs):  # noqa: E501
        ...
        """
        try:
            return self._method_single(sell_compliance.Configuration, '/sell/compliance/v1', sell_compliance.ListingViolationApi, sell_compliance.ApiClient, 'suppress_violation', SellComplianceException, True, ['sell.compliance', 'listing_violation'], (body, content_type, x_ebay_c_marketplace_id), **kwargs)  # noqa: E501
        except Error:
            raise
    ...
    def sell_feed_upload_file(self, content_type, task_id, **kwargs):  # noqa: E501
        """upload_file  
        ...
        """
        try:
            return self._method_single(sell_feed.Configuration, '/sell/feed/v1', sell_feed.TaskApi, sell_feed.ApiClient, 'upload_file', SellFeedException, True, ['sell.feed', 'task'], (content_type, task_id), **kwargs)  # noqa: E501
        except Error:
            raise
    ...
    def sell_logistics_create_from_shipping_quote(self, body, content_type, **kwargs):  # noqa: E501
        ...
        """
        try:
            return self._method_single(sell_logistics.Configuration, '/sell/logistics/v1_beta', sell_logistics.ShipmentApi, sell_logistics.ApiClient, 'create_from_shipping_quote', SellLogisticsException, True, ['sell.logistics', 'shipment'], (body, content_type), **kwargs)  # noqa: E501
        except Error:
            raise
    ...
    def sell_marketing_update_bidding_strategy(self, body, campaign_id, **kwargs):  # noqa: E501
        ...
        """
        try:
            return self._method_single(sell_marketing.Configuration, '/sell/marketing/v1', sell_marketing.CampaignApi, sell_marketing.ApiClient, 'update_bidding_strategy', SellMarketingException, True, ['sell.marketing', 'campaign'], (body, campaign_id), **kwargs)  # noqa: E501
        except Error:
            raise
