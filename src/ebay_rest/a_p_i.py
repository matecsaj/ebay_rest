...
class API(APIPrivate):
    ...
    def commerce_media_create_document_from_url(
    ...
    def commerce_media_create_image_from_file(
        self, content_type, **kwargs
    ):  # noqa: E501
        ...
        return self._method_single(
            commerce_media.Configuration,
            "/commerce/media/v1_beta",
            commerce_media.ImageApi,
            commerce_media.ApiClient,
            "create_image_from_file",
            CommerceMediaException,
            True,
            ["commerce.media", "image"],
            content_type,
            **kwargs,
        )  # noqa: E501

    def commerce_media_create_image_from_url(
    ...
    def sell_finances_get_billing_activities(self, **kwargs):  # noqa: E501
