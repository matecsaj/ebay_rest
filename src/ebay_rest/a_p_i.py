...
class API(metaclass=Multiton):
        ...
        with API._lock_user_token:
            try:
                self._user_token = UserToken(
                    ...
                    user_scopes=None
                    if "scopes" not in self._user
                    else self._user["scopes"],
                    # user token supply
                    user_refresh_token=None
                    if "refresh_token" not in self._user
                    else self._user["refresh_token"],
                    user_refresh_token_expiry=None
    ...
    def _get_swagger_method(
        ...
        api_instance.api_client.default_headers[
            "X-EBAY-C-MARKETPLACE-ID"
        ] = marketplace_id
    ...
    def buy_feed_get_item_feed(
        self, accept, x_ebay_c_marketplace_id, range, feed_scope, category_id, **kwargs
    ):  # noqa: E501
        """get_item_feed
        ...
        try:
            return self._method_single(
                ...
                False,
                ["buy.feed", "item"],
                (accept, x_ebay_c_marketplace_id, range, feed_scope, category_id),
                **kwargs,
            )  # noqa: E501
        except Error:
            raise

    def buy_feed_get_item_group_feed(
        self, accept, x_ebay_c_marketplace_id, feed_scope, category_id, **kwargs
    ):  # noqa: E501
        """get_item_group_feed
        ...
        try:
            return self._method_single(
                buy_feed.Configuration,
                "/buy/feed/v1_beta",
                buy_feed.ItemGroupApi,
                buy_feed.ApiClient,
                "get_item_group_feed",
                BuyFeedException,
                False,
                ["buy.feed", "item_group"],
                (accept, x_ebay_c_marketplace_id, feed_scope, category_id),
                **kwargs,
            )  # noqa: E501
        except Error:
            raise

    def buy_feed_get_item_priority_feed(
        self, accept, x_ebay_c_marketplace_id, range, category_id, _date, **kwargs
    ):  # noqa: E501
        ...
        try:
            return self._method_single(
                buy_feed.Configuration,
                "/buy/feed/v1_beta",
                buy_feed.ItemPriorityApi,
                buy_feed.ApiClient,
                "get_item_priority_feed",
                BuyFeedException,
                False,
                ["buy.feed", "item_priority"],
                (accept, x_ebay_c_marketplace_id, range, category_id, _date),
                **kwargs,
            )  # noqa: E501
        except Error:
            raise

    def buy_feed_get_item_snapshot_feed(
        self,
        accept,
        x_ebay_c_marketplace_id,
        range,
        ...
        **kwargs,
        ...
        try:
            return self._method_single(
                buy_feed.Configuration,
                "/buy/feed/v1_beta",
                buy_feed.ItemSnapshotApi,
                buy_feed.ApiClient,
                "get_item_snapshot_feed",
                BuyFeedException,
                False,
                ["buy.feed", "item_snapshot"],
                (accept, x_ebay_c_marketplace_id, range, category_id, snapshot_date),
                **kwargs,
            )  # noqa: E501
        except Error:
            raise
    ...
    def sell_account_get_advertising_eligibility(
        self, x_ebay_c_marketplace_id, **kwargs
    ):  # noqa: E501
        ...
        try:
            return self._method_single(
                ...
                "/sell/account/v1",
                sell_account.AdvertisingEligibilityApi,
                sell_account.ApiClient,
                "get_advertising_eligibility",
                SellAccountException,
                True,
                ["sell.account", "advertising_eligibility"],
                x_ebay_c_marketplace_id,
                **kwargs,
            )  # noqa: E501
        except Error:
    ...
    def sell_account_create_custom_policy(
        self, body, content_type, **kwargs
    ):  # noqa: E501
        ...
        try:
            return self._method_single(
                sell_account.Configuration,
                "/sell/account/v1",
                sell_account.CustomPolicyApi,
                sell_account.ApiClient,
                "create_custom_policy",
                SellAccountException,
                True,
                ["sell.account", "custom_policy"],
                (body, content_type),
                **kwargs,
            )  # noqa: E501
        except Error:
    ...
    def sell_account_update_custom_policy(
        self, body, content_type, custom_policy_id, **kwargs
    ):  # noqa: E501
        ...
        try:
            return self._method_single(
                ...
                True,
                ["sell.account", "custom_policy"],
                (body, content_type, custom_policy_id),
                **kwargs,
            )  # noqa: E501
        except Error:
            raise

    def sell_account_create_fulfillment_policy(
        self, body, content_type, **kwargs
    ):  # noqa: E501
        ...
        try:
            return self._method_single(
                sell_account.Configuration,
                "/sell/account/v1",
                sell_account.FulfillmentPolicyApi,
                sell_account.ApiClient,
                "create_fulfillment_policy",
                SellAccountException,
                True,
                ["sell.account", "fulfillment_policy"],
                (body, content_type),
                **kwargs,
            )  # noqa: E501
        except Error:
    ...
    def sell_account_delete_fulfillment_policy(
        self, fulfillment_policy_id, **kwargs
    ):  # noqa: E501
    ...
    def sell_account_get_fulfillment_policies(
        self, marketplace_id, **kwargs
    ):  # noqa: E501
    ...
    def sell_account_get_fulfillment_policy(
        self, fulfillment_policy_id, **kwargs
    ):  # noqa: E501
    ...
    def sell_account_get_fulfillment_policy_by_name(
        self, marketplace_id, name, **kwargs
    ):  # noqa: E501
    ...
    def sell_account_update_fulfillment_policy(
        self, body, content_type, fulfillment_policy_id, **kwargs
    ):  # noqa: E501
        ...
        try:
            return self._method_single(
                ...
                True,
                ["sell.account", "fulfillment_policy"],
                (body, content_type, fulfillment_policy_id),
                **kwargs,
            )  # noqa: E501
        except Error:
            raise
    ...
    def sell_account_get_payments_program_onboarding(
        self, marketplace_id, payments_program_type, **kwargs
    ):  # noqa: E501
        ...
        try:
            return self._method_single(
                sell_account.Configuration,
                "/sell/account/v1",
                sell_account.OnboardingApi,
                sell_account.ApiClient,
                "get_payments_program_onboarding",
                SellAccountException,
                True,
                ["sell.account", "onboarding"],
                (marketplace_id, payments_program_type),
                **kwargs,
            )  # noqa: E501
        except Error:
            raise

    def sell_account_create_payment_policy(
        self, body, content_type, **kwargs
    ):  # noqa: E501
        ...
        try:
            return self._method_single(
                sell_account.Configuration,
                "/sell/account/v1",
                sell_account.PaymentPolicyApi,
                sell_account.ApiClient,
                "create_payment_policy",
                SellAccountException,
                True,
                ["sell.account", "payment_policy"],
                (body, content_type),
                **kwargs,
            )  # noqa: E501
        except Error:
    ...
    def sell_account_delete_payment_policy(
        self, payment_policy_id, **kwargs
    ):  # noqa: E501
    ...
    def sell_account_get_payment_policy(
        self, payment_policy_id, **kwargs
    ):  # noqa: E501
        """get_payment_policy
    ...
    def sell_account_get_payment_policy_by_name(
        self, marketplace_id, name, **kwargs
    ):  # noqa: E501
    ...
    def sell_account_update_payment_policy(
        self, body, content_type, payment_policy_id, **kwargs
    ):  # noqa: E501
        ...
        try:
            return self._method_single(
                ...
                True,
                ["sell.account", "payment_policy"],
                (body, content_type, payment_policy_id),
                **kwargs,
            )  # noqa: E501
        except Error:
            raise

    def sell_account_get_payments_program(
        self, marketplace_id, payments_program_type, **kwargs
    ):  # noqa: E501
        ...
        try:
            return self._method_single(
                sell_account.Configuration,
                "/sell/account/v1",
                sell_account.PaymentsProgramApi,
                sell_account.ApiClient,
                "get_payments_program",
                SellAccountException,
                True,
                ["sell.account", "payments_program"],
                (marketplace_id, payments_program_type),
                **kwargs,
            )  # noqa: E501
        except Error:
    ...
    def sell_account_get_privileges(self, **kwargs):  # noqa: E501
        ...
        try:
            return self._method_single(
                sell_account.Configuration,
                "/sell/account/v1",
                sell_account.PrivilegeApi,
                sell_account.ApiClient,
                "get_privileges",
                SellAccountException,
                True,
                ["sell.account", "privilege"],
                None,
                **kwargs,
            )  # noqa: E501
        except Error:
    ...
    def sell_account_opt_in_to_program(
        self, body, content_type, **kwargs
    ):  # noqa: E501
        """opt_in_to_program
    ...
    def sell_account_opt_out_of_program(
        self, body, content_type, **kwargs
    ):  # noqa: E501
        """opt_out_of_program
    ...
    def sell_account_create_return_policy(
        self, body, content_type, **kwargs
    ):  # noqa: E501
        ...
        try:
            return self._method_single(
                sell_account.Configuration,
                "/sell/account/v1",
                sell_account.ReturnPolicyApi,
                sell_account.ApiClient,
                "create_return_policy",
                SellAccountException,
                True,
                ["sell.account", "return_policy"],
                (body, content_type),
                **kwargs,
            )  # noqa: E501
        except Error:
    ...
    def sell_account_delete_return_policy(
        self, return_policy_id, **kwargs
    ):  # noqa: E501
    ...
    def sell_account_get_return_policy_by_name(
        self, marketplace_id, name, **kwargs
    ):  # noqa: E501
    ...
    def sell_account_update_return_policy(
        self, body, content_type, return_policy_id, **kwargs
    ):  # noqa: E501
        ...
        try:
            return self._method_single(
                ...
                True,
                ["sell.account", "return_policy"],
                (body, content_type, return_policy_id),
                **kwargs,
            )  # noqa: E501
        except Error:
            raise

    def sell_account_create_or_replace_sales_tax(
        self, body, content_type, country_code, jurisdiction_id, **kwargs
    ):  # noqa: E501
        ...
        try:
            return self._method_single(
                sell_account.Configuration,
                "/sell/account/v1",
                sell_account.SalesTaxApi,
                sell_account.ApiClient,
                "create_or_replace_sales_tax",
                SellAccountException,
                True,
                ["sell.account", "sales_tax"],
                (body, content_type, country_code, jurisdiction_id),
                **kwargs,
            )  # noqa: E501
        except Error:
            raise

    def sell_account_delete_sales_tax(
        self, country_code, jurisdiction_id, **kwargs
    ):  # noqa: E501
        """delete_sales_tax
    ...
    def sell_account_get_sales_tax(
        self, country_code, jurisdiction_id, **kwargs
    ):  # noqa: E501
        """get_sales_tax
    ...
    def sell_account_get_subscription(self, **kwargs):  # noqa: E501
        ...
        try:
            return self._method_single(
                sell_account.Configuration,
                "/sell/account/v1",
                sell_account.SubscriptionApi,
                sell_account.ApiClient,
                "get_subscription",
                SellAccountException,
                True,
                ["sell.account", "subscription"],
                None,
                **kwargs,
            )  # noqa: E501
        except Error:
    ...
    def sell_compliance_suppress_violation(
