...
class OrderTaskApi(object):
    ...
    def get_order_task(self, task_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str task_id: The ID of the task. This ID is generated when the task was created by the <b> createOrderTask</b> method. (required)
        :return: OrderTask
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_order_tasks(self, **kwargs):  # noqa: E501
        ...
        :param str feed_type: The feed type associated with the task. The only presently supported value is <code>LMS_ORDER_REPORT</code>. Do not use with the <strong>schedule_id</strong> parameter. Since schedules are based on feed types, you can specify a schedule (<strong>schedule_id</strong>) that returns the needed <strong>feed_type</strong>.
