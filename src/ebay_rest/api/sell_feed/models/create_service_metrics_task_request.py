...
class CreateServiceMetricsTaskRequest(object):
    ...
    def feed_type(self):
        ...
        The feedType specified for the task. The report lists the transaction details that contribute to the service metrics evaluation. Supported types include: CUSTOMER_SERVICE_METRICS_REPORT  # noqa: E501
    ...
    def schema_version(self):
        ...
        The version number of the file format. Valid value: 1.0  # noqa: E501
