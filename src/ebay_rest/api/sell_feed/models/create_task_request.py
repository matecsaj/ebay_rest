...
class CreateTaskRequest(object):
    ...
    def schema_version(self):
        ...
        The schemaVersion/version number of the file format (use the schema version of the API to which you are programming): LMS Version Details / Schema Version File Exchange Create UploadJob  # noqa: E501
