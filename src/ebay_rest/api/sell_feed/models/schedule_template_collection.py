...
class ScheduleTemplateCollection(object):
    ...
    def __init__(self, href=None, limit=None, next=None, offset=None, prev=None, schedule_templates=None, total=None):  # noqa: E501
        """ScheduleTemplateCollection - a model defined in Swagger"""  # noqa: E501
        self._href = None
        self._limit = None
        self._next = None
        self._offset = None
        self._prev = None
        self._schedule_templates = None
        self._total = None
        ...
        if prev is not None:
            self.prev = prev
        if schedule_templates is not None:
            self.schedule_templates = schedule_templates
        if total is not None:
            self.total = total

    @property
    def href(self):
        """Gets the href of this ScheduleTemplateCollection.  # noqa: E501

        The path to the call URI that produced the current page of results.  # noqa: E501

        :return: The href of this ScheduleTemplateCollection.  # noqa: E501
        :rtype: str
        """
        return self._href
    ...
    def href(self, href):
        ...
        :param href: The href of this ScheduleTemplateCollection.  # noqa: E501
        :type: str
        """
    ...
    @property
    def next(self):
        """Gets the next of this ScheduleTemplateCollection.  # noqa: E501
        ...
        :return: The next of this ScheduleTemplateCollection.  # noqa: E501
        :rtype: str
        """
        return self._next
    ...
    def next(self, next):
        ...
        :param next: The next of this ScheduleTemplateCollection.  # noqa: E501
        :type: str
        """
    ...
    @property
    def prev(self):
        """Gets the prev of this ScheduleTemplateCollection.  # noqa: E501
        ...
        :return: The prev of this ScheduleTemplateCollection.  # noqa: E501
        :rtype: str
        """
        return self._prev
    ...
    def prev(self, prev):
        ...
        :param prev: The prev of this ScheduleTemplateCollection.  # noqa: E501
        :type: str
        """
    ...
    def schedule_templates(self):
        """Gets the schedule_templates of this ScheduleTemplateCollection.  # noqa: E501

        An array of the schedule templates on this page. An empty array is returned if the filter criteria excludes all tasks.  # noqa: E501

        :return: The schedule_templates of this ScheduleTemplateCollection.  # noqa: E501
    ...
    def schedule_templates(self, schedule_templates):
        ...
        :param schedule_templates: The schedule_templates of this ScheduleTemplateCollection.  # noqa: E501
        :type: list[ScheduleTemplateResponse]
        """
    ...
    @property
    def total(self):
        """Gets the total of this ScheduleTemplateCollection.  # noqa: E501

        The total number of schedule templates that match the input criteria.  # noqa: E501

        :return: The total of this ScheduleTemplateCollection.  # noqa: E501
        :rtype: int
        """
        return self._total
    ...
    def total(self, total):
        ...
        :param total: The total of this ScheduleTemplateCollection.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ScheduleTemplateCollection, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ScheduleTemplateCollection):
            return False
