...
class ListingViolationApi(object):
    ...
    def get_listing_violations(self, x_ebay_c_marketplace_id, compliance_type, **kwargs):  # noqa: E501
        ...
        :param str compliance_type: <span class=\"tablenote\"><b>Note:</b> The <a href=\"https://developer.ebay.com/api-docs/sell/compliance/types/com:ComplianceTypeEnum\" target=\"_blank\" rel=\"noopener\">ASPECTS_ADOPTION</a> compliance type has been deprecated and will be decommissioned on August 31, 2025.</span> <br><br>This query parameter specifies the compliance type of the listing violations being retrieved. Only one compliance type value can be specified. <br> <br>See <a href=\"/api-docs/sell/compliance/types/com:ComplianceTypeEnum\">ComplianceTypeEnum</a> for more information on supported compliance types. (required)
