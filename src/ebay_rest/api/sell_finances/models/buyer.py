...
class Buyer(object):
    ...
    def username(self):
        ...
        The eBay user ID of the order's buyer.<br><br><span class=\"tablenote\"><b>Note:</b> Effective September 26, 2025, select developers will no longer receive username data for U.S. users through this field. Instead, an immutable user ID will be returned in its place. For more information, please refer to <a href=\"/api-docs/static/data-handling-update.html\">Data Handling Compliance</a>. </span>  # noqa: E501
