...
class Transaction(object):
    ...
    def __init__(self, amount=None, booking_entry=None, buyer=None, e_bay_collected_tax_amount=None, fee_jurisdiction=None, fee_type=None, order_id=None, order_line_items=None, payments_entity=None, payout_details=None, payout_id=None, references=None, sales_record_reference=None, total_fee_amount=None, total_fee_basis_amount=None, transaction_date=None, transaction_id=None, transaction_memo=None, transaction_status=None, transaction_type=None):  # noqa: E501
