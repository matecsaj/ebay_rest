...
class ShippingOption(object):
    ...
    def fulfilled_through(self):
        ...
        If the item is being shipped by eBay's <a href=\"https://pages.ebay.com/seller-center/shipping/global-shipping-program.html\">Global Shipping Program</a>, this field returns <code>GLOBAL_SHIPPING</code>. Otherwise this field is null. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/buy/browse/types/gct:FulfilledThroughEnum'>eBay API documentation</a>  # noqa: E501
