...
class ConditionDescriptor(object):
    ...
    swagger_types = {
        'name': 'str',
        'values': 'list[ConditionDescriptorValue]'
    }
    ...
    def name(self):
        ...
        The name of a condition descriptor. The value(s) for this condition descriptor is returned in the associated <b>values</b> array.  # noqa: E501
    ...
    def values(self):
        ...
        This array displays the value(s) for a condition descriptor (denoted by the associated <b>name</b> field), as well as any other additional information about the condition of the item.  # noqa: E501

        :return: The values of this ConditionDescriptor.  # noqa: E501
        :rtype: list[ConditionDescriptorValue]
        """
        return self._values
    ...
    def values(self, values):
        ...
        :type: list[ConditionDescriptorValue]
        """
