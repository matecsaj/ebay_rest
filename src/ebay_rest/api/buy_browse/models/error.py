...
class Error(object):
    ...
    def category(self):
        ...
        This string value indicates the error category. There are three categories of errors: <i>request errors</i>, <i>application errors</i>, and <i>system errors</i>.  # noqa: E501
