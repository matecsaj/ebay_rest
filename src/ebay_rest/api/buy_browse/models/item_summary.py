...
class ItemSummary(object):
    ...
    def priority_listing(self):
        ...
        When true, this container indicates that the item is a priority listing. Priority Listings are a subset of eBay listings identified with a higher priority to be promoted. Note: Priority Listing is returned only with a Best Match sort and will not be returned for other sort options.  # noqa: E501
