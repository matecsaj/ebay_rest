...
class ItemApi(object):
    ...
    def check_compatibility(self, content_type, item_id, **kwargs):  # noqa: E501
        ...
        :param str x_ebay_c_marketplace_id: The ID of the eBay marketplace you want to use. <b> Note: </b> This value is case sensitive.<br><br>For example: <br>&nbsp;&nbsp;<code>X-EBAY-C-MARKETPLACE-ID = EBAY_US</code>  <br><br> For a list of supported sites see, <a href=\"/api-docs/buy/browse/overview.html#API\">API Restrictions</a>.
    ...
    def check_compatibility_with_http_info(self, content_type, item_id, **kwargs):  # noqa: E501
        ...
        all_params = ['content_type', 'item_id', 'body', 'x_ebay_c_marketplace_id']  # noqa: E501
    ...
    def get_item_with_http_info(self, item_id, **kwargs):  # noqa: E501
        ...
        all_params = ['item_id', 'fieldgroups', 'x_ebay_c_enduserctx', 'x_ebay_c_marketplace_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_item_by_legacy_id_with_http_info(self, legacy_item_id, **kwargs):  # noqa: E501
        ...
        all_params = ['legacy_item_id', 'fieldgroups', 'legacy_variation_id', 'legacy_variation_sku', 'x_ebay_c_enduserctx', 'x_ebay_c_marketplace_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_items_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['item_ids', 'item_group_ids', 'x_ebay_c_enduserctx', 'x_ebay_c_marketplace_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_items_by_item_group(self, item_group_id, **kwargs):  # noqa: E501
        ...
        :param str fieldgroups: This field lets you control what is returned in the response. If you do not set this field, the method returns all the details of the item.<br><br><b>Valid Values:</b><br><br><b>ADDITIONAL_SELLER_DETAILS</b> - This adds the <code>userId</code> field to the response. This field provides the seller's user ID. See <a href=\"/api-docs/buy/browse/resources/item/methods/getItemsByItemGroup#response.items.seller.userId\">userId</a> for more information about this field.
        :param str x_ebay_c_enduserctx: This header is required to support revenue sharing for eBay Partner Network and to improve the accuracy of shipping and delivery time estimations.<br>For additional information, refer to <a href=\"/api-docs/buy/static/api-browse.html#Headers\" target=\"_blank \">Use request headers</a>.
        :param str x_ebay_c_marketplace_id: This header identifies the seller's eBay marketplace. It is required for all marketplaces outside of the US.<br><br><span class=\"tablenote\"><b>Note:</b> If a marketplace ID value is not provided, the default value of <code>EBAY_US</code> is used.</span><br>See <a href=\"/api-docs/static/rest-request-components.html#marketpl \" target=\"_blank \">HTTP request headers</a> for the marketplace ID values.
        :return: ItemGroup
                 If the method is called asynchronously,
    ...
    def get_items_by_item_group_with_http_info(self, item_group_id, **kwargs):  # noqa: E501
        ...
        all_params = ['item_group_id', 'fieldgroups', 'x_ebay_c_enduserctx', 'x_ebay_c_marketplace_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
