...
class UserRateLimitApi(object):
    ...
    def get_user_rate_limits(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_user_rate_limits_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_user_rate_limits_with_http_info(self, **kwargs):  # noqa: E501
        """get_user_rate_limits  # noqa: E501

        This method retrieves the call limit and utilization data for an application user. The call-limit data is returned for all RESTful APIs and the legacy Trading API that limit calls on a per-user basis.  <br><br>The response from <b>getUserRateLimits</b> includes a list of the applicable resources and the \"call limit\", or quota, that is set for each resource. In addition to quota information, the response also includes the number of remaining calls available before the limit is reached, the time remaining before the quota resets, and the length of the \"time window\" to which the quota applies.  <br><br>By default, this method returns utilization data for all RESTful APIs resources and the legacy Trading API calls that limit request access by user. Use the <b>api_name</b> and <b>api_context</b> query parameters to filter the response to only the desired APIs.  <br><br>For more on call limits, see <a href=\"https://developer.ebay.com/support/app-check\" target=\"_blank\">Compatible Application Check</a>.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_rate_limits_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['api_context', 'api_name']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_user_rate_limits" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        query_params = []
        if 'api_context' in params:
            query_params.append(('api_context', params['api_context']))  # noqa: E501
        if 'api_name' in params:
            query_params.append(('api_name', params['api_name']))  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='RateLimitsResponse',  # noqa: E501
