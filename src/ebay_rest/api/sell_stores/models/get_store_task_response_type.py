...
class GetStoreTaskResponseType(object):
    ...
    def __init__(self, task=None):  # noqa: E501
        """GetStoreTaskResponseType - a model defined in Swagger"""  # noqa: E501
        self._task = None
    ...
    @property
    def task(self):
        """Gets the task of this GetStoreTaskResponseType.  # noqa: E501


        :return: The task of this GetStoreTaskResponseType.  # noqa: E501
        :rtype: StoreTaskType
        """
        return self._task
    ...
    @task.setter
    def task(self, task):
        """Sets the task of this GetStoreTaskResponseType.


        :param task: The task of this GetStoreTaskResponseType.  # noqa: E501
        :type: StoreTaskType
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetStoreTaskResponseType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetStoreTaskResponseType):
            return False
