...
class StoreLogoType(object):
    ...
    def __init__(self, url=None):  # noqa: E501
        """StoreLogoType - a model defined in Swagger"""  # noqa: E501
        self._url = None
    ...
    @property
    def url(self):
        """Gets the url of this StoreLogoType.  # noqa: E501

        The URL of the seller's store logo.  # noqa: E501

        :return: The url of this StoreLogoType.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this StoreLogoType.

        The URL of the seller's store logo.  # noqa: E501

        :param url: The url of this StoreLogoType.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StoreLogoType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StoreLogoType):
            return False
