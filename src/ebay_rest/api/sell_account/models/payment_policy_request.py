...
class PaymentPolicyRequest(object):
    ...
    def category_types(self):
        ...
        The <b>CategoryTypeEnum</b> value to which this business policy applies. This container is used to discern accounts that sell motor vehicles from those that do not.<br /><br /><b>Restriction:</b> Currently, each business policy can be set to only one <b>categoryTypes</b> value at a time.  # noqa: E501
    ...
    def description(self):
        ...
        An optional seller-defined description of the payment business policy.  <br><br><b>Max length</b>: 250  # noqa: E501
    ...
    def immediate_pay(self):
        ...
        This field should be included and set to 'true' if the seller wants to require immediate payment from the buyer for: <ul><li>A fixed-price item</li><li>An auction item where the buyer is using the 'Buy it Now' option</li><li>A deposit for a motor vehicle listing</li></ul><br /><br /><b>Default:</b> False  # noqa: E501
    ...
    def payment_methods(self):
        ...
        <p class=\"tablenote\"><b>Note:</b> This field applies only when the seller needs to specify one or more offline payment methods. eBay now manages the electronic payment options available to buyers to pay the deposit.</p>This array is used to specify one or more offline payment methods that will be accepted for payment that occurs off of eBay's platform.  # noqa: E501
