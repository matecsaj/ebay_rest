...
class FulfillmentPolicy(object):
    ...
    def fulfillment_policy_id(self):
        ...
        A unique eBay-assigned ID for the fulfillment business policy. This ID is generated when the policy is created.  # noqa: E501
    ...
    def marketplace_id(self):
        ...
        The ID of the eBay marketplace to which this fulfillment business policy applies. applies. If this value is not specified, value defaults to the seller's eBay registration site. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/account/types/ba:MarketplaceIdEnum'>eBay API documentation</a>  # noqa: E501
