...
class RecipientAccountReference(object):
    ...
    def reference_id(self):
        ...
        Contains the PayPal email address of the recipient (seller) if <b>referenceType</b> is set to <code>PAYPAL_EMAIL</code>.  # noqa: E501
    ...
    def reference_type(self):
        ...
        This field's value indicates the type of account where payment will be received. Currently, the only supported value is PAYPAL_EMAIL. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/account/types/api:RecipientAccountReferenceTypeEnum'>eBay API documentation</a>  # noqa: E501
