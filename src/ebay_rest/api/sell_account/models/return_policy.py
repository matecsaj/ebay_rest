...
class ReturnPolicy(object):
    ...
    def return_policy_id(self):
        ...
        A unique eBay-assigned ID for this policy. This ID value is appended to the end of the Location URI that is returned as a response header when you call createReturnPolicy).  # noqa: E501
