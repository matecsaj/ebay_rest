...
class ReturnPolicy(object):
    ...
    def description(self):
        ...
        An optional seller-defined description of the return policy.  <br><br><b>Max length</b>: 250  # noqa: E501
    ...
    def return_policy_id(self):
        ...
        A unique eBay-assigned ID for this policy. This ID value is appended to the end of the <code>Location</code> URI that is returned as a response header when you call <b>createReturnPolicy</b>).  # noqa: E501
