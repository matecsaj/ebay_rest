...
class FulfillmentPolicyRequest(object):
    ...
    def category_types(self):
        ...
        The <b>CategoryTypeEnum</b> value to which this business policy applies. Used to discern accounts that sell motor vehicles from those that don't. (Currently, each business policy can be set to only one <b>categoryTypes</b> value at a time.)  # noqa: E501
    ...
    def description(self):
        ...
        An optional seller-defined description of the fulfillment business policy.  <br><br><b>Max length</b>: 250  # noqa: E501
    ...
    def freight_shipping(self):
        ...
        If set to <code>true</code>, the seller offers freight shipping.  Freight shipping can be used for large items over 150 lbs.<br><br><b>Default</b>: false  # noqa: E501
    ...
    def marketplace_id(self):
        ...
        The ID of the eBay marketplace to which this fulfillment business policy applies. If this value is not specified, value defaults to the seller's eBay registration site. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/account/types/ba:MarketplaceIdEnum'>eBay API documentation</a>  # noqa: E501
    ...
    def name(self):
        ...
        A user-defined name for this fulfillment business policy. Names must be unique for policies assigned to the same marketplace. <br><br><b>Max length</b>: 64  # noqa: E501
    ...
    def pickup_drop_off(self):
        ...
        If set to <code>true</code>, the seller offers the \"Click and Collect\" feature. Click and Collect is supported by the Inventory API, and it can be used with Add/Revise/Relist calls.  <br /><br />To enable \"Click and Collect\", a seller (1) must be eligible for Click and Collect and (2) must set this boolean field to 'true'. Currently, Click and Collect is available to only large retail merchants selling in the eBay AU and UK marketplaces.  <br /><br />In addition to setting this field, the merchant must also do the following to enable the \"Click and Collect\" option on a listing: <ul><li>Have inventory for the product at one or more physical stores tied to the merchant's account. <br />Sellers can use the <b>createInventoryLocation</b> method in the Inventory API to associate physical stores to their account and they can then can add inventory to specific store locations.</li><li>Set an immediate payment requirement on the item. The immediate payment feature requires the seller to: <ul><li>Set the <b>immediatePay</b> flag in the payment business policy to 'true'.</li><li>Have a valid store location with a complete street address.</li></ul></li></ul> <br /><br />When a merchant successfully lists an item with Click and Collect, prospective buyers within a reasonable distance from one of the merchant's stores (that has stock available) will see the \"Available for Click and Collect\" option on the listing, along with information on the closest store that has the item.<br /><br /><b>Default</b>: false  # noqa: E501
