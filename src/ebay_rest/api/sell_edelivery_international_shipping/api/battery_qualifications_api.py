...
class BatteryQualificationsApi(object):
    ...
    def get_battery_qualifications(self, **kwargs):  # noqa: E501
        """get_battery_qualifications  # noqa: E501
        ...
        >>> thread = api.get_battery_qualifications(async_req=True)
        >>> result = thread.get()
        ...
        :param str offset: This query parameter specifies the number of qualifications to skip in the result set before returning the first qualification in the paginated response.<br><br>Combine <b>offset</b> with the <b>limit</b> query parameter to control the items returned in the response. For example, if you supply an <b>offset</b> of <code>0</code> and a <b>limit</b> of <code>10</code>, the first page of the response contains the first 10 items from the complete list of items retrieved by the call.<br><br><b>Default</b>: <code>0</code>
        ...
        if kwargs.get('async_req'):
            return self.get_battery_qualifications_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_battery_qualifications_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_battery_qualifications_with_http_info(self, **kwargs):  # noqa: E501
        """get_battery_qualifications  # noqa: E501

        <div class=\"msgbox_important\"><p class=\"msgbox_importantInDiv\" data-mc-autonum=\"&lt;b&gt;&lt;span style=&quot;color: #dd1e31;&quot; class=&quot;mcFormatColor&quot;&gt;Important! &lt;/span&gt;&lt;/b&gt;\"><span class=\"autonumber\"><span><b><span style=\"color: #dd1e31;\" class=\"mcFormatColor\">Important!</span></b></span></span> This method is only available for Greater-China based sellers with an active eDIS account.</p></div><br>This method is used to retrieve all battery qualifications associated with your eDIS account. This includes the type, electronic qualification ID and name, and expiration date for each battery.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_battery_qualifications_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_battery_qualifications" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='GetBatteryQualListResponses',  # noqa: E501
