...
class ComplaintApi(object):
    ...
    def create_complaint(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.create_complaint_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.create_complaint_with_http_info(**kwargs)  # noqa: E501
            return data

    def create_complaint_with_http_info(self, **kwargs):  # noqa: E501
        """create_complaint  # noqa: E501

        <div class=\"msgbox_important\"><p class=\"msgbox_importantInDiv\" data-mc-autonum=\"&lt;b&gt;&lt;span style=&quot;color: #dd1e31;&quot; class=&quot;mcFormatColor&quot;&gt;Important! &lt;/span&gt;&lt;/b&gt;\"><span class=\"autonumber\"><span><b><span style=\"color: #dd1e31;\" class=\"mcFormatColor\">Important!</span></b></span></span> This method is only available for Greater-China based sellers with an active eDIS account.</p></div><br>This method can be used to create a complaint about a shipment order. Complaints can be filed if there is a pickup delay on an order or if an item has been lost in transit.<br><br>The complaint reason, complaint type, and the date the issue occurred must be specified in the request. If the complaint is being filed for a missing package, the affected <b>packageId</b> values must also be specified in the <b>affectedPackages</b> array.<br><br>If the call was successful, HTTP status code <b>201 Created</b> will be returned, and the complaint will be created.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_complaint_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_complaint" % key
                )
            params[key] = val
        del params['kwargs']
