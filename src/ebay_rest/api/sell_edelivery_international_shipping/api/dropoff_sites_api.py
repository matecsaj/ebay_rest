...
class DropoffSitesApi(object):
    ...
    def get_dropoff_sites(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.get_dropoff_sites_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_dropoff_sites_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_dropoff_sites_with_http_info(self, **kwargs):  # noqa: E501
        """get_dropoff_sites  # noqa: E501

        <div class=\"msgbox_important\"><p class=\"msgbox_importantInDiv\" data-mc-autonum=\"&lt;b&gt;&lt;span style=&quot;color: #dd1e31;&quot; class=&quot;mcFormatColor&quot;&gt;Important! &lt;/span&gt;&lt;/b&gt;\"><span class=\"autonumber\"><span><b><span style=\"color: #dd1e31;\" class=\"mcFormatColor\">Important!</span></b></span></span> This method is only available for Greater-China based sellers with an active eDIS account.</p></div><br>This method can be used to retrieve metadata for one or more drop-off sites associated with a seller's eDIS account.<br><br>Pagination query parameters are provided that allow users to control how many drop-off site locations are returned in the response.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_dropoff_sites_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_dropoff_sites" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='GetDropoffSiteListResponses',  # noqa: E501
