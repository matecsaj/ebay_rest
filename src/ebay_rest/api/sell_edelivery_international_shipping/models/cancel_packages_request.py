...
class CancelPackagesRequest(object):
    ...
    """
    swagger_types = {
        'requests': 'CancelPackagesRequestData'
    }
    ...
    def __init__(self, requests=None):  # noqa: E501
        """CancelPackagesRequest - a model defined in Swagger"""  # noqa: E501
        self._requests = None
    ...
    @property
    def requests(self):
        """Gets the requests of this CancelPackagesRequest.  # noqa: E501


        :return: The requests of this CancelPackagesRequest.  # noqa: E501
        :rtype: CancelPackagesRequestData
        """
        return self._requests

    @requests.setter
    def requests(self, requests):
        """Sets the requests of this CancelPackagesRequest.


        :param requests: The requests of this CancelPackagesRequest.  # noqa: E501
        :type: CancelPackagesRequestData
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CancelPackagesRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CancelPackagesRequest):
            return False
