...
class BundleLabelResponse(object):
    ...
    def __init__(self, label=None):  # noqa: E501
        """BundleLabelResponse - a model defined in Swagger"""  # noqa: E501
        self._label = None
    ...
    @property
    def label(self):
        """Gets the label of this BundleLabelResponse.  # noqa: E501


        :return: The label of this BundleLabelResponse.  # noqa: E501
        :rtype: BundleLabelResponseData
        """
        return self._label

    @label.setter
    def label(self, label):
        """Sets the label of this BundleLabelResponse.


        :param label: The label of this BundleLabelResponse.  # noqa: E501
        :type: BundleLabelResponseData
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BundleLabelResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BundleLabelResponse):
            return False
