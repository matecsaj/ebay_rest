...
class DeletePackagesRequest(object):
    ...
    """
    swagger_types = {
        'requests': 'DeletePackagesRequestData'
    }
    ...
    def __init__(self, requests=None):  # noqa: E501
        """DeletePackagesRequest - a model defined in Swagger"""  # noqa: E501
        self._requests = None
    ...
    @property
    def requests(self):
        """Gets the requests of this DeletePackagesRequest.  # noqa: E501


        :return: The requests of this DeletePackagesRequest.  # noqa: E501
        :rtype: DeletePackagesRequestData
        """
        return self._requests

    @requests.setter
    def requests(self, requests):
        """Sets the requests of this DeletePackagesRequest.


        :param requests: The requests of this DeletePackagesRequest.  # noqa: E501
        :type: DeletePackagesRequestData
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeletePackagesRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeletePackagesRequest):
            return False
