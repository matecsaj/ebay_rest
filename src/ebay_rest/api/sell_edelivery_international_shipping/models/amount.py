...
class Amount(object):
    ...
    def value(self):
        ...
        The monetary amount, in the currency specified by the <b>currency</b> field.<br><br>Both the <b>value</b> and <b>currency</b> fields are required/always returned when expressing cost.  # noqa: E501
