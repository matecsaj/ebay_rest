...
class BundleLabelResponseData(object):
    ...
    def __init__(self, base64_str=None):  # noqa: E501
        """BundleLabelResponseData - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def base64_str(self):
        """Gets the base64_str of this BundleLabelResponseData.  # noqa: E501

        The base 64 string value for the bundle label.<br><br>This string value can be converted into a PDF file.  # noqa: E501

        :return: The base64_str of this BundleLabelResponseData.  # noqa: E501
        :rtype: str
        """
    ...
    def base64_str(self, base64_str):
        """Sets the base64_str of this BundleLabelResponseData.

        The base 64 string value for the bundle label.<br><br>This string value can be converted into a PDF file.  # noqa: E501

        :param base64_str: The base64_str of this BundleLabelResponseData.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BundleLabelResponseData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BundleLabelResponseData):
            return False
