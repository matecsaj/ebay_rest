...
class ShippingAddress(object):
    ...
    def address_line1(self):
        ...
        The first line of the street address where the item is being shipped. Maximum: 40 characters for AU, CA, and US marketplaces 35 characters for DE and GB marketplaces 50 characters for all other marketplaces  # noqa: E501
    ...
    def address_line2(self):
        ...
        The second line of the street address where the item is being shipped. This optional field can be used for information such as 'Suite Number' or 'Apt Number'. Maximum: 40 characters for AU, CA, and US marketplaces 35 characters for DE and GB marketplaces 50 characters for all other marketplaces  # noqa: E501
    ...
    def postal_code(self):
        ...
        The postal code of the address where the item is being shipped. Note: This is optional when shipping to EBAY_HK (Hong Kong).  # noqa: E501
    ...
    def state_or_province(self):
        ...
        The state or province of the address. Note: For the US marketplace, this is a two-character value. For a list of valid values, see US State and Canada Province Codes.  # noqa: E501
