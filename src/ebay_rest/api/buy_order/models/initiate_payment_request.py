...
class InitiatePaymentRequest(object):
    ...
    def __init__(self, payment_method_brand_type=None, payment_method_type=None):  # noqa: E501
        """InitiatePaymentRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def payment_method_brand_type(self):
        """Gets the payment_method_brand_type of this InitiatePaymentRequest.  # noqa: E501

        The enumeration value that specifies the payment method company. Note: The only value supported for the initiateGuestPayment method is PAYPAL_CHECKOUT. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/buy/order/types/gct:PaymentMethodBrandEnum'>eBay API documentation</a>  # noqa: E501

        :return: The payment_method_brand_type of this InitiatePaymentRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def payment_method_brand_type(self, payment_method_brand_type):
        """Sets the payment_method_brand_type of this InitiatePaymentRequest.

        The enumeration value that specifies the payment method company. Note: The only value supported for the initiateGuestPayment method is PAYPAL_CHECKOUT. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/buy/order/types/gct:PaymentMethodBrandEnum'>eBay API documentation</a>  # noqa: E501

        :param payment_method_brand_type: The payment_method_brand_type of this InitiatePaymentRequest.  # noqa: E501
        :type: str
        """
    ...
    def payment_method_type(self):
        """Gets the payment_method_type of this InitiatePaymentRequest.  # noqa: E501

        The enumeration value that specifies the payment method type. Note: The only value supported for the initiateGuestPayment method is WALLET. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/buy/order/types/gct:PaymentMethodTypeEnum'>eBay API documentation</a>  # noqa: E501

        :return: The payment_method_type of this InitiatePaymentRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def payment_method_type(self, payment_method_type):
        """Sets the payment_method_type of this InitiatePaymentRequest.

        The enumeration value that specifies the payment method type. Note: The only value supported for the initiateGuestPayment method is WALLET. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/buy/order/types/gct:PaymentMethodTypeEnum'>eBay API documentation</a>  # noqa: E501

        :param payment_method_type: The payment_method_type of this InitiatePaymentRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InitiatePaymentRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InitiatePaymentRequest):
            return False
