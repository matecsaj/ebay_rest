...
class GuestPurchaseOrderApi(object):
    ...
    def get_guest_purchase_order(self, purchase_order_id, **kwargs):  # noqa: E501
        ...
        :param str x_ebay_c_enduserctx: This header is used to specify the <b>deviceId</b> for the device/user attempting to make the call. It contains an alphanumeric string that allows a payment gateway to track an API call attempt and confirm that it is a verified payment attempt by a device/user.
    ...
    def get_guest_purchase_order_with_http_info(self, purchase_order_id, **kwargs):  # noqa: E501
        ...
        all_params = ['purchase_order_id', 'x_ebay_c_marketplace_id', 'x_ebay_c_enduserctx']  # noqa: E501
