...
class DimensionMetric(object):
    ...
    def metrics(self):
        ...
        This is a list of Metric elements where each element contains data and information related to the transactions grouped by the associated dimension.  # noqa: E501
