...
class Header(object):
    ...
    def dimension_keys(self):
        ...
        A list of the dimension or metric keys returned in the report. The values for each are is returned in the associated key fields.  # noqa: E501
    ...
    def metrics(self):
        ...
        The list of metrics returned in the report. The values for each are is returned in the associated key fields.  # noqa: E501
