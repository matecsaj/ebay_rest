...
class Definition(object):
    ...
    def data_type(self):
        ...
        Indicates the data type of the returned dimension. For example, if the <b>dimension</b> is <code>day</code>, the data type is <code>DATE</code>. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/analytics/types/ssp:DataTypeEnum'>eBay API documentation</a>  # noqa: E501
    ...
    def key(self):
        ...
        The value the <b>dimension</b> or <b>metric</b> parameter as submitted in the request.  # noqa: E501
    ...
    def localized_name(self):
        ...
        The localized name of the metric or dimension (translated into the language specified in the <b>Accept-Language</b> HTTP request header). For example, if <b>Accept-Language</b> is set to <code>de-DE</code>, the value \"day\" in the <b>dimension</b> container is returned as \"tag\", and a metric of TRANSACTION is returned as \"Transaktionsanzahl\".  # noqa: E501
