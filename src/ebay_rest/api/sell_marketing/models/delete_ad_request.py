...
class DeleteAdRequest(object):
    ...
    def listing_id(self):
        ...
        A unique eBay-assigned identifier for a listing that is generated when the listing is created.  <p class=\"tablenote\"><b>Note:</b> This request accepts both listing IDs, as generated by the Inventory API, and an item IDs, as used in the eBay Traditional API set (e.g., the Trading and Finding APIs).</p>  # noqa: E501
