...
class Alert(object):
    ...
    def __init__(self, alert_type=None, details=None):  # noqa: E501
    ...
    def alert_type(self):
        ...
        The type of alert message. For example, an invalid bid percentage. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/pls:AlertTypeEnum'>eBay API documentation</a>  # noqa: E501
    ...
    def details(self):
        ...
        A description of the alert including dimensions and aspects.  # noqa: E501
