...
class BulkDeleteAdResponse(object):
    ...
    def __init__(self, responses=None):  # noqa: E501
        """BulkDeleteAdResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BulkDeleteAdResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BulkDeleteAdResponse):
            return False
