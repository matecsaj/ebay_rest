...
class CreateAdRequest(object):
    ...
    def ad_group_id(self):
        ...
        A unique eBay-assigned identifier for an ad group in a campaign that uses the Cost Per Click (CPC) funding model.<br><br>Use the <a href=\"/api-docs/sell/marketing/resources/adgroup/methods/getAdGroups\">getAdGroups</a> method to retrieve the ad group IDs for a seller.<br><br><span class=\"tablenote\"><b>Note:</b> This field is required for manual targeting campaigns using the Cost Per Click (CPC) funding model.</span>  # noqa: E501
    ...
    def listing_id(self):
        ...
        A unique identifier of an eBay listing.  # noqa: E501
