...
class RuleCriteria(object):
    ...
    def exclude_inventory_items(self):
        ...
        A list of seller inventory reference IDs to exclude from the promotion.<br><p class=\"tablenote\"><b>Note:</b> The request can have either <b>excludeInventoryItems</b> or <b>excludeListingIds</b> but not both.</p> <b>Maximum:</b> 100 parent items<br><br><b>Maximum SKU or custom label length:</b> 50 characters  # noqa: E501
