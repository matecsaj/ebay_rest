...
class DeleteAdsByInventoryReferenceResponse(object):
    ...
    def ad_ids(self):
        ...
        The list of ad IDs that were removed from the campaign.  # noqa: E501
    ...
    def status_code(self):
        ...
        An HTTP status code that indicates the response-status of the request. Check this code to see if the ads were successfully deleted.  # noqa: E501
