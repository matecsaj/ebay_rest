...
class Campaign(object):
    ...
    def __init__(self, alerts=None, budget=None, campaign_criterion=None, campaign_id=None, campaign_name=None, campaign_status=None, campaign_targeting_type=None, channels=None, end_date=None, funding_strategy=None, marketplace_id=None, start_date=None):  # noqa: E501
    ...
    def campaign_targeting_type(self):
        """Gets the campaign_targeting_type of this Campaign.  # noqa: E501

        The targeting type of the campaign. This value indicates whether the campaign is a manual targeting or smart targeting ad campaign. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/pls:CampaignTargetingTypeEnum'>eBay API documentation</a>  # noqa: E501

        :return: The campaign_targeting_type of this Campaign.  # noqa: E501
        :rtype: str
        """
    ...
    def campaign_targeting_type(self, campaign_targeting_type):
        """Sets the campaign_targeting_type of this Campaign.

        The targeting type of the campaign. This value indicates whether the campaign is a manual targeting or smart targeting ad campaign. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/pls:CampaignTargetingTypeEnum'>eBay API documentation</a>  # noqa: E501

        :param campaign_targeting_type: The campaign_targeting_type of this Campaign.  # noqa: E501
        :type: str
        """
    ...
    @property
    def channels(self):
        """Gets the channels of this Campaign.  # noqa: E501

        The channel for the campaign. This value indicates whether the campaign is an Onsite or Offsite advertising campaign. <br><br><b>Valid Values:</b><ul><li><code>ON_SITE</code></li><li><code>OFF_SITE</code></li></ul>  # noqa: E501

        :return: The channels of this Campaign.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def channels(self, channels):
        """Sets the channels of this Campaign.

        The channel for the campaign. This value indicates whether the campaign is an Onsite or Offsite advertising campaign. <br><br><b>Valid Values:</b><ul><li><code>ON_SITE</code></li><li><code>OFF_SITE</code></li></ul>  # noqa: E501

        :param channels: The channels of this Campaign.  # noqa: E501
        :type: list[str]
        """
