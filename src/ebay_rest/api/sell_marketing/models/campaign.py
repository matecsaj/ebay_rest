...
class Campaign(object):
    ...
    def __init__(self, alerts=None, budget=None, campaign_criterion=None, campaign_id=None, campaign_name=None, campaign_status=None, channels=None, end_date=None, funding_strategy=None, marketplace_id=None, start_date=None):  # noqa: E501
