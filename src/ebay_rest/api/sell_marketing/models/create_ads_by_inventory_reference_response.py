...
class CreateAdsByInventoryReferenceResponse(object):
    ...
    def inventory_reference_type(self):
        ...
        Indicates the type of item the <b>inventoryReferenceId</b> references. The item can be either an <code>INVENTORY_ITEM</code> or an <code>INVENTORY_ITEM_GROUP</code>. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/pls:InventoryReferenceTypeEnum'>eBay API documentation</a>  # noqa: E501
    ...
    def status_code(self):
        ...
        An HTTP status code that indicates the response-status of the request. Check this code to see if the ads were successfully created.  # noqa: E501
