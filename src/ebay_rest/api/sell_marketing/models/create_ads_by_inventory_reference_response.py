...
class CreateAdsByInventoryReferenceResponse(object):
    ...
    def ads(self):
        ...
        A list of ad IDs (based on their inventory reference IDs) and the URIs that point to them.  # noqa: E501
    ...
    def status_code(self):
        ...
        An HTTP status code that indicates the response-status of the request. Check this code to see if the ads were successful created.  # noqa: E501
