...
class UpdateCampaignIdentificationRequest(object):
    ...
    def end_date(self):
        ...
        The new date and time the campaign ends, in UTC format (<code>yyyy-MM-ddThh:mm:ssZ</code>). If this field is blank (code>null</code>), it indicates a campaign that has no end date. For display purposes, convert this time into the local time of the seller.  # noqa: E501
