...
class PromotionsPagedCollection(object):
    ...
    def promotions(self):
        ...
        A list containing the details of each returned discount. This includes all the information about the discounts except for the listings that are discounted.  # noqa: E501
