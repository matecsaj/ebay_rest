...
class KeywordRequest(object):
    ...
    def match_type(self):
        ...
        A field that defines the match type for the keyword.<br /><br /><span class=\"tablenote\"><strong>Note:</strong> Currently, the only supported match type for <b>suggestBids</b> is <code>EXACT</code>.</span> For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/pls:MatchTypeEnum'>eBay API documentation</a>  # noqa: E501
