...
class SelectionRule(object):
    ...
    def listing_condition_ids(self):
        ...
        The unique identifier for the listing condition.<br /><br /><span class=\"tablenote\"><strong>Note:</strong> This array is only returned if one or more item condition values are used as a filter.</span><br /><br /><strong>Valid Values:</strong><ul><li><code>1000</code> = New</li><li><code>2000</code> = Certified Refurbished</li><li><code>2500</code> = Seller Refurbished</li><li><code>3000</code> = Used</li></ul>  # noqa: E501
