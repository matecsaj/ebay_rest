...
class DeleteAdResponse(object):
    ...
    def ad_id(self):
        ...
        The unique identifier of the ad that was deleted, or the ad that the seller attempted to delete.  # noqa: E501
    ...
    def status_code(self):
        ...
        An HTTP status code that indicates the response-status of the request. Check this code to see if the ad was successfully deleted.<span class=\"tablenote\"><b>Note:</b>A status code is returned for each ad that the seller deletes, or attempts to delete.</span>  # noqa: E501
