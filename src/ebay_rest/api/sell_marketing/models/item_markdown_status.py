...
class ItemMarkdownStatus(object):
    ...
    def listing_markdown_status(self):
        ...
        Indicates the state assigned to the markdown discount using one of the <b>status</b> values. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/sme:ItemMarkdownStatusEnum'>eBay API documentation</a>  # noqa: E501
    ...
    def status_changed_date(self):
        ...
        Identifies the date the last time the state of the discount changed. Both both markdown and markup events can trigger a status change.  # noqa: E501
    ...
    def status_message(self):
        ...
        An eBay-assigned text string that describes the status of the discount.  # noqa: E501
