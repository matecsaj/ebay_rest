...
class EmailCampaignApi(object):
    ...
    def delete_email_campaign(self, email_campaign_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str email_campaign_id: A unique eBay-assigned ID for an email campaign that is generated when an email campaign is created.<br /><br /><span class=\"tablenote\"><b>Note:</b> You can retrieve the email campaign IDs for a specified seller using the <a href=\"/api-docs/sell/marketing/resources/email_campaign/methods/getEmailCampaigns\">getEmailCampaigns</a> method.</span> (required)
    ...
    def get_audiences(self, email_campaign_type, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str email_campaign_type: The email campaign type to search against. See <a href=\"/api-docs/sell/marketing/types/api:CampaignTypeEnum\" target=\"_blank\">CampaignTypeEnum</a> for the full list of available email campaign types and associated enum values. (required)
    ...
    def get_email_campaign(self, email_campaign_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str email_campaign_id: The unique eBay-assigned ID of the email campaign.<br><br>Call <a href=\"/api-docs/sell/marketing/resources/campaign/methods/getEmailCampaigns\">getEmailCampaigns</a> to retrieve a list of email campaign IDs for a seller. Use the <b>emailCampaignId</b> value of the desired email campaign. (required)
    ...
    def get_email_campaigns(self, **kwargs):  # noqa: E501
        ...
        :param str q: This field contains filter criteria for the results returned. Filter by <a href=\"/api-docs/sell/marketing/types/api:CampaignTypeEnum\">email campaign type</a>, <a href=\"/api-docs/sell/marketing/types/api:EmailCampaignStatusEnum\">email campaign status</a>, and <a href=\"/api-docs/sell/marketing/types/ba:MarketplaceIdEnum\">marketplace ID</a>.<br><br>For example, setting <code>q=campaignType:WELCOME,ITEM_SHOWCASE;status:ACTIVE</code> will return only active Welcome and Item Showcase email campaigns.<br><br>If no filter is set up through the <code>q</code> query parameter, all of the seller's campaigns will be returned in the results set. 
    ...
    def get_email_preview(self, email_campaign_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str email_campaign_id: The email campaign id assigned by the system when the email campaign is created. Call <a href=\"/api-docs/sell/marketing/resources/campaign/methods/getEmailCampaigns\">getEmailCampaigns</a> to retrieve a list of email campaign IDs for a seller. (required)
