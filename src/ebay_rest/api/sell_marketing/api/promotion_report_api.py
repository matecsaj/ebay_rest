...
class PromotionReportApi(object):
    ...
    def get_promotion_reports(self, marketplace_id, **kwargs):  # noqa: E501
        ...
        :param str marketplace_id: This parameter specifies the eBay marketplace ID of the site for which you want the promotions report.<br><br>See <a href=\"/api-docs/sell/marketing/types/ba:MarketplaceIdEnum\">MarketplaceIdEnum</a> for supported Marketplace ID values. (required)
        ...
        :param str promotion_status: This parameter specifies the promotion state by which you want to filter the results. <br><br>See <a href=\"/api-docs/sell/marketing/types/sme:PromotionStatusEnum\" target=\"_blank\">PromotionStatusEnum</a> for supported values.<br><br><b>Maximum number of input values:</b> 1
