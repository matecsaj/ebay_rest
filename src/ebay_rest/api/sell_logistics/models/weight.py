...
class Weight(object):
    ...
    def value(self):
        ...
        The numeric value of the weight of the package, as measured by the value of <b>unit</b>.  # noqa: E501
