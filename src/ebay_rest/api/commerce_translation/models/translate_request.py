...
class TranslateRequest(object):
    ...
    def _from(self):
        ...
        The language of the input text to be translated. Not all <b>LanguageEnum</b> values are supported in this field. For a full list of supported language translations, see the table in the <a href=\"/api-docs/commerce/translation/overview.html\">API Overview</a> page. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/commerce/translation/types/api:LanguageEnum'>eBay API documentation</a>  # noqa: E501
    ...
    def to(self):
        ...
        The target language for the translation of the input text. Not all <b>LanguageEnum</b> values are supported in this field. For a full list of supported language translations, see the table in the <a href=\"/api-docs/commerce/translation/overview.html\">API Overview</a> page. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/commerce/translation/types/api:LanguageEnum'>eBay API documentation</a>  # noqa: E501
