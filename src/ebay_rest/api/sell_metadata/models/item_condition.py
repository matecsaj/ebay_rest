...
class ItemCondition(object):
    ...
    swagger_types = {
        ...
        'condition_descriptors': 'list[ItemConditionDescriptor]',
        'condition_help_text': 'str',
        'condition_id': 'str',
        'usage': 'str'
    }
    ...
    def __init__(self, condition_description=None, condition_descriptors=None, condition_help_text=None, condition_id=None, usage=None):  # noqa: E501
        """ItemCondition - a model defined in Swagger"""  # noqa: E501
        self._condition_description = None
        self._condition_descriptors = None
        self._condition_help_text = None
        ...
        if condition_help_text is not None:
            self.condition_help_text = condition_help_text
    ...
    def condition_descriptors(self):
        """Gets the condition_descriptors of this ItemCondition.  # noqa: E501

        This array contains the possible condition descriptors and condition descriptor values applicable for the specified category. It also returns usage requirements, maximum length, cardinality, and help text.<br><br><span class=\"tablenote\"><b>Note:</b> This array is only returned for categories that support condition descriptors.</span>  # noqa: E501

        :return: The condition_descriptors of this ItemCondition.  # noqa: E501
        :rtype: list[ItemConditionDescriptor]
        """
        return self._condition_descriptors

    @condition_descriptors.setter
    def condition_descriptors(self, condition_descriptors):
        """Sets the condition_descriptors of this ItemCondition.

        This array contains the possible condition descriptors and condition descriptor values applicable for the specified category. It also returns usage requirements, maximum length, cardinality, and help text.<br><br><span class=\"tablenote\"><b>Note:</b> This array is only returned for categories that support condition descriptors.</span>  # noqa: E501

        :param condition_descriptors: The condition_descriptors of this ItemCondition.  # noqa: E501
        :type: list[ItemConditionDescriptor]
        """
    ...
    def condition_help_text(self):
        """Gets the condition_help_text of this ItemCondition.  # noqa: E501

        A detailed description of the condition denoted by the <b>conditionID</b> and <b>conditionDescription</b>.   # noqa: E501

        :return: The condition_help_text of this ItemCondition.  # noqa: E501
        :rtype: str
        """
        return self._condition_help_text

    @condition_help_text.setter
    def condition_help_text(self, condition_help_text):
        """Sets the condition_help_text of this ItemCondition.

        A detailed description of the condition denoted by the <b>conditionID</b> and <b>conditionDescription</b>.   # noqa: E501

        :param condition_help_text: The condition_help_text of this ItemCondition.  # noqa: E501
        :type: str
        """

        self._condition_help_text = condition_help_text
