...
class ItemConditionPolicy(object):
    ...
    def item_conditions(self):
        ...
        The item-condition values allowed in the category. Note: In all eBay marketplaces, Condition ID 2000 now maps to an item condition of 'Certified Refurbished', and not 'Manufacturer Refurbished'. To list an item as 'Certified Refurbished', a seller must be pre-qualified by eBay for this feature. Any seller who is not eligible for this feature will be blocked if they try to create a new listing or revise an existing listing with this item condition. Any seller that is interested in eligibility requirements to list with 'Certified Refurbished' should see the Certified refurbished program page in Seller Center. Note: For the Cell Phones &amp; Smartphones category (9355), the SELLER_REFURBISHED condition is being deprecated. Sellers trying to list an item in this category (9355) with the condition SELLER_REFURBISHED will be blocked. Starting September 1, 2021, existing listings for this category (9355) with this item condition will be ended by eBay but three new additional refurbished items conditions will be available: EXCELLENT_REFURBISHED, VERY_GOOD_REFURBISHED, and GOOD_REFURBISHED. To be eligible to list with these three item conditions, sellers will have to go through an application process. See Cameras &amp; Photo, Cell Phones &amp; Accessories... for details.  # noqa: E501
