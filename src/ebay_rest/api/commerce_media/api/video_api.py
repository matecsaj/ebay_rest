...
class VideoApi(object):
    ...
    def create_video_with_http_info(self, content_type, **kwargs):  # noqa: E501
        ...
        all_params = ['content_type', 'body', 'files', 'files']  # noqa: E501 - ebay_rest patch: added files support - ebay_rest patch: added files support
