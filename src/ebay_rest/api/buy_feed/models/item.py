...
"""
    ...
    OpenAPI spec version: v1_beta.35.1
...
class Item(object):
    ...
    def repair_score(self):
        ...
        A score that describes how easy it is to repair the product. Score values range from 0.1 (hardest to repair) to 10.0 (easiest), always including a single decimal place.<br><br><span class=\"tablenote\"><b>Note:</b> Support for this field is currently limited to the France marketplace.</span>  # noqa: E501
