...
class ItemPriorityResponse(object):
    ...
    def __init__(self, item_delta=None):  # noqa: E501
        """ItemPriorityResponse - a model defined in Swagger"""  # noqa: E501
        self._item_delta = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ItemPriorityResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ItemPriorityResponse):
            return False
