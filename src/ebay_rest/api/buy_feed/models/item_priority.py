...
class ItemPriority(object):
    ...
    def __init__(self, change_metadata=None, item_id=None, priority_listing_payload=None):  # noqa: E501
    ...
    def change_metadata(self):
        ...
        Status change indicator of the listing. Values: ADDED_TO_CAMPAIGN REMOVED_FROM_CAMPAIGN TRACKING_PAYLOAD_REFRESHEDNote: When a listing is removed from the campaign, PriorityListingPayload will be empty. When multiple status changes are returned for a listing, the changeMetadata value will be a pipe-separated string (e.g., ADDED_TO_CAMPAIGN|TRACKING_PAYLOAD_REFRESHED). To use the returned value, you will need to separate the string by pipe (|).  # noqa: E501
