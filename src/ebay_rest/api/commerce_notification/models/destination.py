...
class Destination(object):
    ...
    def delivery_config(self):
        ...
        The configuration associated with this destination. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/commerce/notification/types/destination'>eBay API documentation</a>  # noqa: E501
