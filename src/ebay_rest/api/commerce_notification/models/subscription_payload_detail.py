...
class SubscriptionPayloadDetail(object):
    ...
    def delivery_protocol(self):
        ...
        The supported protocol. For exmaple: HTTPS For implementation help, refer to <a href='https://developer.ebay.com/api-docs/commerce/notification/types/api:ProtocolEnum'>eBay API documentation</a>  # noqa: E501
