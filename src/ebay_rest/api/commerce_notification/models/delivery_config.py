...
class DeliveryConfig(object):
    ...
    def endpoint(self):
        ...
        The endpoint for this destination.<br><br><span class=\"tablenote\"><b>Note:</b> The provided endpoint URL should use the HTTPS protocol, and it should not contain an internal IP address or <code>localhost</code> in its path.</span>  # noqa: E501
