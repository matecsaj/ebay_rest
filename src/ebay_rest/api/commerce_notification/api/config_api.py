...
class ConfigApi(object):
    ...
    def update_config(self, content_type, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_config(content_type, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.update_config_with_http_info(content_type, **kwargs)  # noqa: E501
            return data

    def update_config_with_http_info(self, content_type, **kwargs):  # noqa: E501
        """update_config  # noqa: E501

        This method allows applications to create a new configuration or update an existing configuration. This app-level configuration allows developers to set up alerts.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_config_with_http_info(content_type, async_req=True)
        >>> result = thread.get()
        ...
        if ('content_type' not in params or
            ...
            raise ValueError("Missing the required parameter `content_type` when calling `update_config`")  # noqa: E501
