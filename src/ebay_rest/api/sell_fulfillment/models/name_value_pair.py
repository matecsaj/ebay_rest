...
class NameValuePair(object):
    ...
    def name(self):
        ...
        The text representing the name of the aspect for the name-value pair. For example, <code>color</code>, or <code>Tire Type</code>.  # noqa: E501
    ...
    def value(self):
        ...
        The value of the aspect for the name-value pair. For example, <code>red</code>, or <code>All Season</code>.  # noqa: E501
