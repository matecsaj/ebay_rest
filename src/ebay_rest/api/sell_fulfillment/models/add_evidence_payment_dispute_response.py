...
class AddEvidencePaymentDisputeResponse(object):
    ...
    def __init__(self, evidence_id=None):  # noqa: E501
        """AddEvidencePaymentDisputeResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AddEvidencePaymentDisputeResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddEvidencePaymentDisputeResponse):
            return False
