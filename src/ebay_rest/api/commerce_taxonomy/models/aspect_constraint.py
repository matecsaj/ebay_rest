...
class AspectConstraint(object):
    ...
    def aspect_applicable_to(self):
        ...
        This value indicate if the aspect identified by the aspects.localizedAspectName field is a product aspect (relevant to catalog products in the category) or an item/instance aspect, which is an aspect whose value will vary based on a particular instance of the product.  # noqa: E501
    ...
    def aspect_enabled_for_variations(self):
        ...
        A value of true indicates that this aspect can be used to help identify item variations.  # noqa: E501
    ...
    def aspect_format(self):
        ...
        Returned only if the value of aspectDataType identifies a data type that requires specific formatting. Currently, this field provides formatting hints as follows: DATE: YYYY, YYYYMM, YYYYMMDD NUMBER: int32, double  # noqa: E501
    ...
    def aspect_required(self):
        ...
        A value of true indicates that this aspect is required when offering items in the specified category.  # noqa: E501
    ...
    def expected_required_by_date(self):
        ...
        The expected date after which the aspect will be required. Note: The value returned in this field specifies only an approximate date, which may not reflect the actual date after which the aspect is required.  # noqa: E501
    ...
    def item_to_aspect_cardinality(self):
        ...
        Indicates whether this aspect can accept single or multiple values for items in the specified category. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/commerce/taxonomy/types/txn:ItemToAspectCardinalityEnum'>eBay API documentation</a>  # noqa: E501
