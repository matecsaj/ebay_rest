...
class EventItemApi(object):
    ...
    def get_event_items(self, event_ids, x_ebay_c_marketplace_id, **kwargs):  # noqa: E501
        ...
        :param str event_ids: The unique identifiers for the eBay events.<br /><br /><b>Maximum Value:</b> <code>1</code> (required)
        ...
        :param str category_ids: The unique identifier of the eBay category for the search.<br /><br /><b>Maximum Value:</b> <code>1</code>
