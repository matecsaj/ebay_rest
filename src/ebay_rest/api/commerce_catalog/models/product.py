...
"""
    ...
    OpenAPI spec version: v1_beta.5.3
...
class Product(object):
    ...
    def __init__(self, additional_images=None, aspects=None, brand=None, compatibility_count=None, description=None, ean=None, epid=None, gtin=None, image=None, isbn=None, mpn=None, other_applicable_category_ids=None, primary_category_id=None, product_web_url=None, title=None, upc=None, version=None):  # noqa: E501
        """Product - a model defined in Swagger"""  # noqa: E501
        self._additional_images = None
        self._aspects = None
        self._brand = None
        self._compatibility_count = None
        ...
        if brand is not None:
            self.brand = brand
        if compatibility_count is not None:
            self.compatibility_count = compatibility_count
    ...
    @property
    def compatibility_count(self):
        """Gets the compatibility_count of this Product.  # noqa: E501

        The number of distinct motor vehicles that are compatible with the product.<br><br>This field is only applicable for and will only be returned for Parts & Accessory products on the eBay US Motors marketplace.  # noqa: E501

        :return: The compatibility_count of this Product.  # noqa: E501
        :rtype: int
        """
        return self._compatibility_count

    @compatibility_count.setter
    def compatibility_count(self, compatibility_count):
        """Sets the compatibility_count of this Product.

        The number of distinct motor vehicles that are compatible with the product.<br><br>This field is only applicable for and will only be returned for Parts & Accessory products on the eBay US Motors marketplace.  # noqa: E501

        :param compatibility_count: The compatibility_count of this Product.  # noqa: E501
        :type: int
        """

        self._compatibility_count = compatibility_count
