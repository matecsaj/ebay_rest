...
class InventoryItemWithSkuLocale(object):
    ...
    def locale(self):
        ...
        This request parameter sets the natural language that will be provided in the field values of the request payload (i.e., en_AU, en_GB or de_DE). For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/inventory/types/slr:LocaleEnum'>eBay API documentation</a>  # noqa: E501
