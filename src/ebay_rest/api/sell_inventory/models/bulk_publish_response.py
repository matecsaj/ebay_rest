...
class BulkPublishResponse(object):
    ...
    """
    swagger_types = {
        'responses': 'list[OfferResponseWithListingId]'
    }
    ...
    def __init__(self, responses=None):  # noqa: E501
        """BulkPublishResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BulkPublishResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BulkPublishResponse):
            return False
