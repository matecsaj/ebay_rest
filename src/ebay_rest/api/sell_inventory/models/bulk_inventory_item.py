...
class BulkInventoryItem(object):
    ...
    def __init__(self, requests=None):  # noqa: E501
        """BulkInventoryItem - a model defined in Swagger"""  # noqa: E501
        self._requests = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BulkInventoryItem, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BulkInventoryItem):
            return False
