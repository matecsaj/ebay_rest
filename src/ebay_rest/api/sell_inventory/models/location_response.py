...
class LocationResponse(object):
    ...
    @property
    def href(self):
        """Gets the href of this LocationResponse.  # noqa: E501

        The URI of the current page of results from the result set.  # noqa: E501

        :return: The href of this LocationResponse.  # noqa: E501
        :rtype: str
        """
        return self._href
    ...
    @href.setter
    def href(self, href):
        """Sets the href of this LocationResponse.

        The URI of the current page of results from the result set.  # noqa: E501

        :param href: The href of this LocationResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def limit(self):
        """Gets the limit of this LocationResponse.  # noqa: E501

        The number of items returned on a single page from the result set.  # noqa: E501

        :return: The limit of this LocationResponse.  # noqa: E501
        :rtype: int
        """
        return self._limit
    ...
    def limit(self, limit):
        """Sets the limit of this LocationResponse.

        The number of items returned on a single page from the result set.  # noqa: E501

        :param limit: The limit of this LocationResponse.  # noqa: E501
        :type: int
        """
    ...
    @property
    def offset(self):
        """Gets the offset of this LocationResponse.  # noqa: E501

        The number of results skipped in the result set before listing the first returned result. This value is set in the request with the offset query parameter. Note: The items in a paginated result set use a zero-based list where the first item in the list has an offset of 0.  # noqa: E501

        :return: The offset of this LocationResponse.  # noqa: E501
        :rtype: int
        """
        return self._offset
    ...
    def offset(self, offset):
        """Sets the offset of this LocationResponse.

        The number of results skipped in the result set before listing the first returned result. This value is set in the request with the offset query parameter. Note: The items in a paginated result set use a zero-based list where the first item in the list has an offset of 0.  # noqa: E501

        :param offset: The offset of this LocationResponse.  # noqa: E501
        :type: int
        """
