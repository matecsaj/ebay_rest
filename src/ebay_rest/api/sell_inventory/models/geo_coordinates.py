...
class GeoCoordinates(object):
    ...
    def latitude(self):
        ...
        The latitude (North-South) component of the geographic coordinate. This field is required if a <strong>geoCoordinates</strong> container is used. <br><br>For In-Store Pickup inventory, geographical coordinates are required.<br><br>This field is returned if geographical coordinates are set for the inventory location.  # noqa: E501
    ...
    def longitude(self):
        ...
        The longitude (East-West) component of the geographic coordinate. This field is required if a <strong>geoCoordinates</strong> container is used. <br><br>For In-Store Pickup inventory, geographical coordinates are required.<br><br>This field is returned if geographical coordinates are set for the inventory location.  # noqa: E501
