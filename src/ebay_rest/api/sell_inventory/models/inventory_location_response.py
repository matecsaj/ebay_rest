...
class InventoryLocationResponse(object):
    ...
    def __init__(self, location=None, location_additional_information=None, location_instructions=None, location_types=None, location_web_url=None, merchant_location_key=None, merchant_location_status=None, name=None, operating_hours=None, phone=None, special_hours=None, time_zone_id=None, fulfillment_center_specifications=None):  # noqa: E501
    ...
    def location_additional_information(self):
        ...
        This text field provides additional information about an inventory location. This field is returned if it is set for the location.  # noqa: E501
    ...
    def location_types(self):
        ...
        This container defines the function of the inventory location. Typically, a location will serve as a store, warehouse, or fulfillment center, but in some cases, an inventory location may be more than one type.  # noqa: E501
    ...
    def location_web_url(self):
        ...
        This text field shows the  Website address (URL) associated with the inventory location. This field is returned if defined for the location.  # noqa: E501
    ...
    def merchant_location_key(self):
        ...
        The unique identifier of the inventory location. This identifier is set up by the merchant when the location is first created with the <strong>createInventoryLocation</strong> call.  # noqa: E501
    ...
    def operating_hours(self):
        ...
        This container shows the regular operating hours for a store location during the days of the week. A <strong>dayOfWeekEnum</strong> field and an <strong>intervals</strong> container is shown for each day of the week that the location is open.  # noqa: E501
    ...
    def phone(self):
        ...
        The phone number for an inventory location. This field will typically only be returned for store locations.  # noqa: E501
    ...
    def special_hours(self):
        ...
        This container shows the special operating hours for a store or fulfillment center location on a specific date or dates.  # noqa: E501
    ...
    def time_zone_id(self):
        """Gets the time_zone_id of this InventoryLocationResponse.  # noqa: E501
        ...
        :return: The time_zone_id of this InventoryLocationResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def time_zone_id(self, time_zone_id):
        """Sets the time_zone_id of this InventoryLocationResponse.

        This field specifies the time zone of the inventory location being created. This value should be in Olson format (for example <code>America/Vancouver</code>). For supported values, see <a href=\"https://howtodoinjava.com/java/date-time/supported-zone-ids-offsets/#3-java-supported-zone-ids-and-offsets\" target=\"_blank\">Java Supported Zone Ids and Offsets</a>.  # noqa: E501

        :param time_zone_id: The time_zone_id of this InventoryLocationResponse.  # noqa: E501
        :type: str
        """
    ...
    def fulfillment_center_specifications(self):
        """Gets the fulfillment_center_specifications of this InventoryLocationResponse.  # noqa: E501


        :return: The fulfillment_center_specifications of this InventoryLocationResponse.  # noqa: E501
    ...
    def fulfillment_center_specifications(self, fulfillment_center_specifications):
        """Sets the fulfillment_center_specifications of this InventoryLocationResponse.


        :param fulfillment_center_specifications: The fulfillment_center_specifications of this InventoryLocationResponse.  # noqa: E501
