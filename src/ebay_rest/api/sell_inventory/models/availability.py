...
class Availability(object):
    ...
    def pickup_at_location_availability(self):
        """Gets the pickup_at_location_availability of this Availability.  # noqa: E501

        This container consists of an array of one or more of the merchant's physical store locations where the inventory item is available for In-Store Pickup orders. The merchant's location, the quantity available, and the fulfillment time (how soon the item will be ready for pickup after the order takes place) are all in this container. In-Store Pickup is only available to large merchants selling on the US, UK, Germany, and Australia sites.  # noqa: E501

        :return: The pickup_at_location_availability of this Availability.  # noqa: E501
    ...
    def pickup_at_location_availability(self, pickup_at_location_availability):
        """Sets the pickup_at_location_availability of this Availability.

        This container consists of an array of one or more of the merchant's physical store locations where the inventory item is available for In-Store Pickup orders. The merchant's location, the quantity available, and the fulfillment time (how soon the item will be ready for pickup after the order takes place) are all in this container. In-Store Pickup is only available to large merchants selling on the US, UK, Germany, and Australia sites.  # noqa: E501

        :param pickup_at_location_availability: The pickup_at_location_availability of this Availability.  # noqa: E501
    ...
    def ship_to_location_availability(self):
        """Gets the ship_to_location_availability of this Availability.  # noqa: E501


        :return: The ship_to_location_availability of this Availability.  # noqa: E501
    ...
    def ship_to_location_availability(self, ship_to_location_availability):
        """Sets the ship_to_location_availability of this Availability.


        :param ship_to_location_availability: The ship_to_location_availability of this Availability.  # noqa: E501
