...
class ListingPolicies(object):
    ...
    def __init__(self, best_offer_terms=None, e_bay_plus_if_eligible=None, fulfillment_policy_id=None, payment_policy_id=None, return_policy_id=None, shipping_cost_overrides=None):  # noqa: E501
